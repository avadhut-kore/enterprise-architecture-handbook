# Integration Architecture: Anti-Corruption Layer (ACL) Architecture

## 1. Architectural Purpose & Problem Context
Preventing legacy models or foreign bounded contexts from bleeding into new core domains.
