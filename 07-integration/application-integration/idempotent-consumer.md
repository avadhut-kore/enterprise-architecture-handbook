# Integration Architecture: Idempotent Consumer Pattern

## 1. Architectural Purpose & Problem Context
Handling at-least-once message delivery safely without side-effect duplication or financial double-posting.
