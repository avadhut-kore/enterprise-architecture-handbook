# Integration Architecture: Asynchronous Integration: Event-Driven Boundaries

## 1. Architectural Purpose & Problem Context
Decoupling systems temporally using pub/sub events, eventual consistency, and compensation flows.
