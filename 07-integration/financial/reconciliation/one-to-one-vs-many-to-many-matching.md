# Reconciliation Architecture: One-to-One, One-to-Many & Many-to-Many Matching

## 1. Architectural Purpose & Problem Context
Algorithmic complexity: 1:1 transaction matching vs 1:N batch payouts vs N:M netting reconciliation with fee deduplication.
