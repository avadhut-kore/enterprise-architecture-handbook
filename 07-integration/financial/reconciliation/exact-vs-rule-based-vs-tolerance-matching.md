# Reconciliation Architecture: Exact vs Rule-Based vs Tolerance Matching

## 1. Architectural Purpose & Problem Context
Evaluating match criteria: strict key/amount exact matching vs rule-based heuristic cascades vs penny-rounding tolerance thresholds.
