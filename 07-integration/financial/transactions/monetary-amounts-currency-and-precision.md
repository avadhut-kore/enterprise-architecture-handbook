# Financial Transactions: Monetary Amounts, Currency & Decimal Precision

## 1. Architectural Purpose & Problem Context
Zero-loss financial arithmetic: integer minor units (cents/satoshis), arbitrary precision (BigDecimal), ISO 4217 currencies, and banker's rounding.
