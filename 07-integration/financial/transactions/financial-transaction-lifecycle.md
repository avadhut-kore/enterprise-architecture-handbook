# Financial Transactions: Financial Transaction Lifecycle & State Transitions

## 1. Architectural Purpose & Problem Context
State machine: Initiated -> Authorized -> Captured -> Cleared -> Settled -> Reconciled; handling terminal states (Failed, Voided, Expired).
