# Financial Transactions: Authorizations, Captures & Pre-Authorization Holds

## 1. Architectural Purpose & Problem Context
Two-step payment models: balance verification, authorization expiration windows (7-30 days), partial captures, and voiding uncaptured holds.
