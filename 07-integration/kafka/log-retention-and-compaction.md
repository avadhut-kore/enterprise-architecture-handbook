# Kafka Architecture: Log Retention & Log Compaction Mechanics

## 1. Architectural Purpose & Problem Context
Time vs size cleanup policies, tombstone records, cleaner threads, and maintaining the latest key state in compacted topics.
