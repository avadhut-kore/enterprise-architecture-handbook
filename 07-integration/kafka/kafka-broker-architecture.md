# Kafka Architecture: Kafka Broker Architecture & KRaft Consensus

## 1. Architectural Purpose & Problem Context
Broker internals: page cache utilization, zero-copy `sendfile`, log segment appending, and KRaft metadata consensus replacing ZooKeeper.
