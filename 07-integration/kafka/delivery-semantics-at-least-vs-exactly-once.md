# Kafka Architecture: Delivery Semantics: At-Least-Once vs Exactly-Once (EOS)

## 1. Architectural Purpose & Problem Context
The reality of exactly-once semantics: scoped strictly to Kafka-to-Kafka pipelines via transactional coordinator and markers.
