# Kafka Architecture: Producer Architecture & Idempotency Guarantees

## 1. Architectural Purpose & Problem Context
Producer batching, compression (Snappy/Zstd), `acks=all`, producer epoch and sequence numbers for duplicate prevention.
