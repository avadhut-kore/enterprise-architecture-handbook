# Kafka Architecture: Schema Registry & Avro/Protobuf Evolution Architecture

## 1. Architectural Purpose & Problem Context
Centralized schema governance: schema IDs prepended to message payloads, compatibility checks (BACKWARD/FULL), and CI validation.
