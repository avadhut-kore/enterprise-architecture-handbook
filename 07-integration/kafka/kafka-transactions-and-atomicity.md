# Kafka Architecture: Kafka Transactions & Multi-Partition Atomicity

## 1. Architectural Purpose & Problem Context
Atomic read-process-write loops across topics: transaction coordinator, transaction log, and two-phase commit commit markers.
