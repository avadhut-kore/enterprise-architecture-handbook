# Kafka Architecture: Kafka Failure Scenarios & Disaster Recovery

## 1. Architectural Purpose & Problem Context
Triage playbooks: broker crashes, ISR shrinkage, unclean leader election risks, network partitions, and MirrorMaker 2 active-passive DR.
