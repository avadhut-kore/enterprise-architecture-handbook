# Kafka Architecture: Consumer Groups, Rebalancing & Offset Management

## 1. Architectural Purpose & Problem Context
Cooperative Sticky partition assignor, consumer heartbeat threads, static group membership, and avoiding rebalance storms.
