# GraphQL Architecture: Query Complexity & Depth Limiting Governance

## 1. Architectural Purpose & Problem Context
Preventing Denial of Service (DoS) via malicious circular queries: calculating AST complexity scores and rejecting expensive operations.
