# API Architecture: API Contracts & OpenAPI Specifications

## 1. Architectural Purpose & Problem Context
Authoring robust OpenAPI 3.1 / JSON Schema specs: semantic types, automated mock servers, contract testing, and generating client SDKs.
