# Webhook Architecture: Webhook Cryptographic Signatures & Security

## 1. Architectural Purpose & Problem Context
HMAC-SHA256 signature verification headers (`X-Signature`), shared secret rotation, payload tamper prevention, and replay attack defense.
