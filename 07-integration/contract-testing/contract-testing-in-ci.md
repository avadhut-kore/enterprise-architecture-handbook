# Contract Testing: Contract Testing in CI/CD Pipelines (can-i-deploy)

## 1. Architectural Purpose & Problem Context
Using the Pact `can-i-deploy` CLI tool to gate deployments based on contract verification status.
