# Contract Testing: Asynchronous Event & Message Contract Testing

## 1. Architectural Purpose & Problem Context
Verifying Kafka/RabbitMQ message schemas and payload semantics between producers and consumers.
