# Integration Pattern: Wire Tap Pattern for Auditing & Inspection

## 1. Pattern Purpose & Context
Siphoning a copy of message traffic to a secondary audit or telemetry channel without modifying or impeding the primary message flow.
