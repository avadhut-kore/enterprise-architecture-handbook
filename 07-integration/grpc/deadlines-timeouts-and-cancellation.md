# gRPC Architecture: Deadlines, Timeouts & Cancellation Propagation

## 1. Architectural Purpose & Problem Context
Propagating deadlines across downstream call chains, preventing server thread waste, and handling `DEADLINE_EXCEEDED` gracefully.
