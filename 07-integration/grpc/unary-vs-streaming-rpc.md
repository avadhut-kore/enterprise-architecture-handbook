# gRPC Architecture: Unary vs Streaming RPC Architectures

## 1. Architectural Purpose & Problem Context
Comparing request/reply (Unary), Server-streaming, Client-streaming, and Bidirectional streaming: flow control and state management.
