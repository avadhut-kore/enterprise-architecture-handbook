# gRPC Architecture: Protocol Buffers Contracts & Code Generation

## 1. Architectural Purpose & Problem Context
Binary wire serialization, backward-compatible field numbering rules, strongly typed IDLs, and automated multi-language SDK compilation.
