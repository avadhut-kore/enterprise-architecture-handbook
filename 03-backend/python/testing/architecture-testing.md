# Python Enterprise Architecture: Automated Architecture Testing with import-linter

## 1. Architectural Purpose & Problem Context
Enforcing package layers, forbidden dependencies, and modular boundaries.
