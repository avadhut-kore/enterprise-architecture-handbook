# Python Enterprise Architecture: Bulkheads & Concurrency Limiting via Semaphores

## 1. Architectural Purpose & Problem Context
asyncio.Semaphore to limit concurrent outbound connections to third-party APIs.
