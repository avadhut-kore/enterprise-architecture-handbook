# Python Enterprise Architecture: Hexagonal Architecture (Ports & Adapters) in Python

## 1. Architectural Purpose & Problem Context
Abstract base classes (ABCs) as ports and concrete infrastructure adapters.
