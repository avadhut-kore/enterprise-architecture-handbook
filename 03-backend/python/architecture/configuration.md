# Python Enterprise Architecture: Configuration Architecture with Pydantic Settings

## 1. Architectural Purpose & Problem Context
Pydantic-settings, environment variable parsing, validation, and secret masking.
