# .NET Enterprise Architecture: Host Lifecycle & Hosted Services

## 1. Architectural Purpose & Problem Context
IHost, IHostedService, and IHostApplicationLifetime startup and graceful termination sequences.
