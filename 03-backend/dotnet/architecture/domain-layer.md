# .NET Enterprise Architecture: Pure Domain Modeling in C#

## 1. Architectural Purpose & Problem Context
Leveraging C# 12+ records, value types, and nullable reference types to model expressive, framework-free domain logic.
