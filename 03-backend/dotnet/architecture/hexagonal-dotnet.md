# .NET Enterprise Architecture: Hexagonal Architecture (Ports & Adapters) in C#

## 1. Architectural Purpose & Problem Context
Designing driving and driven ports using modern C# interfaces and dependency injection.
