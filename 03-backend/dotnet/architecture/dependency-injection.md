# .NET Enterprise Architecture: Dependency Injection Engine Internals

## 1. Architectural Purpose & Problem Context
Architectural rules for Microsoft.Extensions.DependencyInjection: Service lifetimes, captive dependencies, and validation scopes.
