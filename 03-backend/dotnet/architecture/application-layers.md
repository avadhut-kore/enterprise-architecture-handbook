# .NET Enterprise Architecture: Application Layering in .NET Solutions

## 1. Architectural Purpose & Problem Context
Structuring solution files (.sln) and project references (.csproj) to enforce architectural boundaries.
