# .NET Enterprise Architecture: Background Processing via BackgroundService

## 1. Architectural Purpose & Problem Context
Long-running queue consumers, channel-based worker loops, and cancellation token propagation.
