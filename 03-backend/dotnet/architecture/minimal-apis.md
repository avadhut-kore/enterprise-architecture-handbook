# .NET Enterprise Architecture: Minimal APIs vs Controller Architecture

## 1. Architectural Purpose & Problem Context
Performance, memory overhead, and modularity trade-offs between Minimal APIs and traditional MVC Controllers.
