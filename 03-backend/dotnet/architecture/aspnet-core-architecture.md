# .NET Enterprise Architecture: ASP.NET Core Server Architecture

## 1. Architectural Purpose & Problem Context
Internal architecture of Kestrel, reverse proxy integration (YARP), and request processing pipelines.
