# .NET Enterprise Architecture: .NET Runtime Architecture Overview

## 1. Architectural Purpose & Problem Context
Execution model of CoreCLR, JIT compilation, GC, and assembly loading in enterprise applications.
