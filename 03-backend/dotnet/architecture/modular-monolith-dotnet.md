# .NET Enterprise Architecture: Modular Monoliths in .NET

## 1. Architectural Purpose & Problem Context
Structuring multi-module solutions with assembly-level internal visibility and in-process MediatR notifications.
