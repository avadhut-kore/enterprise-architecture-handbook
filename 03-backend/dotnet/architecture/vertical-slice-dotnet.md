# .NET Enterprise Architecture: Vertical Slice Architecture in .NET

## 1. Architectural Purpose & Problem Context
Organizing .NET applications with MediatR or FastEndpoints around independent feature slices.
