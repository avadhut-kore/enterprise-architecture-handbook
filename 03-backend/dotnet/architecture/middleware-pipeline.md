# .NET Enterprise Architecture: Middleware Pipeline Architecture

## 1. Architectural Purpose & Problem Context
Execution order, short-circuiting, branching, and exception handling in the ASP.NET Core request delegate pipeline.
