# .NET Enterprise Architecture: Request Validation via FluentValidation

## 1. Architectural Purpose & Problem Context
Separating validation logic from domain models and integrating into the endpoint pipeline.
