# .NET Enterprise Architecture: Idempotency Implementation in ASP.NET Core

## 1. Architectural Purpose & Problem Context
Idempotency-Key middleware with distributed cache storage for non-idempotent endpoints.
