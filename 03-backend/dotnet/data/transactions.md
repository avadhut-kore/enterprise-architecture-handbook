# .NET Enterprise Architecture: Transaction Management in .NET

## 1. Architectural Purpose & Problem Context
Local database transactions, execution strategies, retries, and System.Transactions distributed transaction trade-offs.
