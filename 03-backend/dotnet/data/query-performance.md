# .NET Enterprise Architecture: EF Core Query Performance & Optimization

## 1. Architectural Purpose & Problem Context
AsNoTracking, compiled queries, projection optimization, split queries, and avoiding N+1 query traps.
