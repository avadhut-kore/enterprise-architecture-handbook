# .NET Enterprise Architecture: The Repository Pattern with EF Core

## 1. Architectural Purpose & Problem Context
When adding a repository layer over EF Core is an antipattern and when domain abstraction is justified.
