# .NET Enterprise Architecture: Concurrency Control & Conflict Resolution

## 1. Architectural Purpose & Problem Context
Optimistic concurrency via rowversion/concurrency tokens and handling DbUpdateConcurrencyException.
