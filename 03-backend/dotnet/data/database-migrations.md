# .NET Enterprise Architecture: Database Migrations & Schema Evolution

## 1. Architectural Purpose & Problem Context
EF Core migrations in CI/CD, idempotent SQL script generation, and zero-downtime Blue/Green migrations.
