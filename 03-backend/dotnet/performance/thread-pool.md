# .NET Enterprise Architecture: ThreadPool Starvation & Concurrency Tuning

## 1. Architectural Purpose & Problem Context
ThreadPool worker/IOCP threads, min/max thread configuration, and thread starvation symptoms.
