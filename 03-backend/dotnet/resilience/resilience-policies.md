# .NET Enterprise Architecture: Composing Standard Resilience Pipelines

## 1. Architectural Purpose & Problem Context
Configuring standard HTTP resilience pipelines in .NET 8 via AddStandardResilienceHandler.
