# Node.js & TypeScript Architecture: Middleware Architecture & Request Context

## 1. Architectural Purpose & Problem Context
Request lifecycle, AsyncLocalStorage for request-scoped context, and correlation ID propagation.
