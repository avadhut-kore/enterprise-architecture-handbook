# Node.js & TypeScript Architecture: Asynchronous Programming Architecture

## 1. Architectural Purpose & Problem Context
Promises, async/await, microtask queues, avoiding unhandled rejections, and AbortController.
