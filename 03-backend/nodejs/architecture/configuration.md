# Node.js & TypeScript Architecture: Configuration Architecture with Zod & Envalid

## 1. Architectural Purpose & Problem Context
Environment variable validation, strongly typed config objects, and secret protection.
