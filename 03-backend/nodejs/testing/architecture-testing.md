# Node.js & TypeScript Architecture: Automated Architecture Governance with dependency-cruiser

## 1. Architectural Purpose & Problem Context
Enforcing package boundaries and detecting circular dependencies in CI.
