# Java Enterprise Architecture: Spring Transaction Management Architecture

## 1. Architectural Purpose & Problem Context
@Transactional proxies, propagation rules (REQUIRED, REQUIRES_NEW), and rollback rules.
