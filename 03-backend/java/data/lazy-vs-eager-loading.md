# Java Enterprise Architecture: Lazy vs Eager Loading & N+1 Query Trap

## 1. Architectural Purpose & Problem Context
Fetching strategies, EntityGraph, JOIN FETCH, and eliminating lazy initialization exceptions.
