# Java Enterprise Architecture: Garbage Collection Tuning: ZGC vs G1GC

## 1. Architectural Purpose & Problem Context
Low-latency garbage collection with Generational ZGC, pause time goals, and heap sizing.
