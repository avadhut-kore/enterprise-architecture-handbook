# Java Enterprise Architecture: Integration Testing with Testcontainers Java

## 1. Architectural Purpose & Problem Context
Spinning up real PostgreSQL, Kafka, and Redis containers in Maven/Gradle builds.
