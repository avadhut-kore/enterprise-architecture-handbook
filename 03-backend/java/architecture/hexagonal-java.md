# Java Enterprise Architecture: Hexagonal Architecture (Ports & Adapters) in Java

## 1. Architectural Purpose & Problem Context
Designing driving ports for web/CLI and driven ports for persistence and messaging.
