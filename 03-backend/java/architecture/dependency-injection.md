# Java Enterprise Architecture: Spring Dependency Injection Architecture

## 1. Architectural Purpose & Problem Context
Bean scopes (Singleton, Prototype, Request), circular dependency resolution, and constructor injection.
