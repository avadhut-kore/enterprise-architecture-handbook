# Java Enterprise Architecture: Spring Framework & Spring Boot Internals

## 1. Architectural Purpose & Problem Context
ApplicationContext, BeanFactory, auto-configuration mechanics, and starter dependencies.
