# Cross-Language Architecture: Hexagonal Architecture (Ports & Adapters) Across Languages

## 1. Architectural Purpose & Problem Context
Implementing driving/driven ports across static vs dynamically typed runtimes.
