# Cross-Language Architecture: Transaction Boundaries & Unit of Work

## 1. Architectural Purpose & Problem Context
EF Core SaveChanges, Spring @Transactional, SQLAlchemy AsyncSession, and Prisma transactions.
