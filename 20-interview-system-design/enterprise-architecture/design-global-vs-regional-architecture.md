# Enterprise Architecture Scenario: Design Global vs Regional Architecture
...
> "Architecting systems across US, EU, and APAC that comply with regional data residency (GDPR, PIPL) while maintaining global scale."
