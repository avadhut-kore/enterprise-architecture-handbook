# Enterprise Architecture Scenario: Design a Global Platform Engineering Strategy
...
> "Building an Internal Developer Platform (IDP) on Kubernetes that standardizes golden paths for 3,000 developers."
