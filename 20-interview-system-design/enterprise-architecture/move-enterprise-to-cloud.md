# Enterprise Architecture Scenario: Move a Regulated Enterprise to the Cloud
...
> "Executing a multi-year datacenter exit moving 800 banking applications to an AWS/Azure hybrid landing zone under strict regulatory compliance."
