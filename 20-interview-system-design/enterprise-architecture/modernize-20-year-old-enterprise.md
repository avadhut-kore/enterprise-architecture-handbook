# Enterprise Architecture Scenario: Modernize a 20-Year-Old Enterprise Legacy Core
...
> "Migrating a mission-critical on-premises COBOL/Oracle mainframe core into cloud-native microservices with zero downtime."
