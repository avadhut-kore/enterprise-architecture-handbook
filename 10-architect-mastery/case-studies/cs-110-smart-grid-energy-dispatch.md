# CS-110: Smart Grid Utility Real-Time Energy Balancing

## 1. Executive Summary
Balancing power grid across 10M smart meters during extreme weather cold snap with sub-second IoT dispatch.
