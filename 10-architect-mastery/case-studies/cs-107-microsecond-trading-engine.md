# CS-107: Wall Street Microsecond Trading Engine

## 1. Executive Summary
Modernizing high-frequency trading matching engine with FPGA kernel bypass, achieving sub-10 microsecond latency.
