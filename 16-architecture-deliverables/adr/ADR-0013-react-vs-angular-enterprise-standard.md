# ADR-0013: Frontend Framework Selection: React for Customer-Facing vs Angular for Core Operations
...
Authorize React/Next.js for consumer/marketing web applications and Angular with Nx for complex internal operational portals.
