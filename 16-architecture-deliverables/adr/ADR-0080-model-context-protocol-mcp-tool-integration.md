# ADR-0080: Adopting Model Context Protocol (MCP) for Enterprise Tool Integration
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Standardize on the open Model Context Protocol (MCP) specification for exposing internal databases, APIs, and microservices to AI agents."*
