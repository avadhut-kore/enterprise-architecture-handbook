# ADR-0041: Mandatory Client-Supplied Idempotency Keys on Financial Operations
...
Enforce unique client idempotency keys on all monetary mutations, with atomic reservation locks and cached response replays.
