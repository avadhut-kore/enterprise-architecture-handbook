# ADR-0036: Federated Integration Governance Model
...
Establish a federated integration governance model: central platform team automates tooling, while domain teams build and own integrations.
