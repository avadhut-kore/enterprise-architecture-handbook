# ADR-0023: Enterprise Messaging Platform Selection: Kafka vs RabbitMQ
...
Standardize on Apache Kafka for high-throughput replayable event streams, and RabbitMQ for transient task queues and complex routing.
