# ADR-0021: Database-per-Service vs Shared Database Pattern
...
Mandate isolated database schemas per service to enforce bounded context autonomy; prohibit shared database access across service boundaries.
