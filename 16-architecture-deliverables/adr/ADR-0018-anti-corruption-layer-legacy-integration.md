# ADR-0018: Mandatory Anti-Corruption Layer for Legacy System Integrations
...
Require an Anti-Corruption Layer (ACL) for any integration with core legacy platforms to prevent legacy data model leakage.
