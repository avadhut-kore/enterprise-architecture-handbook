# ADR-0077: Standardizing on Hybrid Search with Cross-Encoder Reranking
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Mandate combining sparse BM25 keyword search and dense HNSW vector search via Reciprocal Rank Fusion, followed by neural rerankers."*
