# ADR-0040: Formal Settlement Source-of-Truth Determination
...
Designate the acquiring bank settlement statement (camt.053) as the legal source of truth for settled funds, not internal authorization logs.
