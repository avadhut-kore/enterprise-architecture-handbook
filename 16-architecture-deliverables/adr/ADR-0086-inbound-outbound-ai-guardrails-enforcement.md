# ADR-0086: Multi-Tier Inbound and Outbound AI Guardrails Enforcement
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Deploy dual-perimeter guardrails (Llama Guard 3 and schema validators) to intercept prompt injection and prevent sensitive data leakage."*
