# ADR-0030: Adoption of Backend-for-Frontend (BFF) Pattern for Client Channels
...
Adopt dedicated BFF services owned by frontend squads for web and mobile channels to decouple client UX from internal domain APIs.
