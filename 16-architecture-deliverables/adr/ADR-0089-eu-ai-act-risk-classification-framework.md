# ADR-0089: Adoption of EU AI Act Risk-Tiered Governance Framework
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Classify all internal and customer-facing AI use cases into Unacceptable, High, Limited, and Minimal risk tiers with mandatory ARB gating."*
