# ADR-0027: Data Lakehouse Architecture Adoption with Apache Iceberg
...
Standardize enterprise analytical storage on open lakehouse table formats (Apache Iceberg) over proprietary data warehouse formats.
