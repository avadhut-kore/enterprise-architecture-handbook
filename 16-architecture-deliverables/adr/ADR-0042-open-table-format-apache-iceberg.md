# ADR-0042: Adoption of Apache Iceberg as Standard Open Table Format
...
Standardize enterprise analytical table storage on Apache Iceberg to prevent cloud vendor lock-in and enable engine interoperability.
