# ADR-0093: Standardizing on Server-Sent Events (SSE) for Real-Time Token Streaming
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Mandate Server-Sent Events (SSE) over HTTP/2 for all interactive conversational interfaces, enforcing non-buffering proxy configurations."*
