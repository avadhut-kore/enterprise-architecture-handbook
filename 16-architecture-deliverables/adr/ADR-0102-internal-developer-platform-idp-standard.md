# ADR-0102: Internal Developer Platform (IDP) Standard
...
Developers spent 6 weeks waiting for ticket-based infrastructure provisioning.

Build and mandate a central Internal Developer Platform (IDP) on Kubernetes.
...
## 4. Decision Outcome
**Self-service portal (Backstage) provisions compliant, observable Kubernetes microservice scaffolds in 15 minutes.**
