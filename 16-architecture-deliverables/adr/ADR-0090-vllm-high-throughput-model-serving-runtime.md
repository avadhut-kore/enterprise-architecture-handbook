# ADR-0090: Standardizing on vLLM with PagedAttention for Self-Hosted Inference
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Select vLLM as the standard Kubernetes runtime for serving open-weights models, utilizing continuous batching and PagedAttention memory management."*
