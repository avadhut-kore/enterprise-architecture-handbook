# ADR-0078: Decoupling Retrieval and Generation via Parent-Child Chunking
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Adopt parent-child chunking to index small 128-token child chunks for high retrieval precision while returning 1024-token parent sections for generation."*
