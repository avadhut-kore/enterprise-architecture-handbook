# ADR-0082: In-Memory Semantic Caching for High-Frequency LLM Queries
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Deploy Redis vector similarity caching at the AI Gateway to serve repeated prompts with similarity >= 0.96 in <15ms at zero token cost."*
