# ADR-0016: Cross-Platform Mobile Strategy: React Native for Enterprise Apps
...
Adopt React Native as the primary cross-platform mobile technology stack, reserving Swift/Kotlin strictly for device-specific hardware drivers.
