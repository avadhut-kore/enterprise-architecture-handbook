# ADR-0025: REST vs GraphQL for Frontend Application Integration
...
Authorize GraphQL specifically for composite client applications requiring flexible multi-service aggregation; maintain REST as default.
