# ADR-0024: gRPC Adoption for Internal High-Throughput Inter-Service RPC
...
Mandate gRPC with Protocol Buffers for synchronous internal microservice-to-microservice communication; restrict REST to external edges.
