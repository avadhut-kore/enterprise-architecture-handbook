# ADR-0095: Automated Architectural Fitness Functions for Continuous AI Quality Governance
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Integrate automated architecture fitness functions into build pipelines to enforce token budget limits, latency ceilings, and modularity constraints."*
