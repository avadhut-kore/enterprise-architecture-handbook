# ADR-0091: Intra-Node Tensor Parallelism on NVLink H100 GPU Clusters
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Standardize large model deployments (70B+) on 8-GPU SXM5 H100 nodes with NVLink tensor parallelism; scale out via independent data replicas."*
