# ADR-0092: Speculative Decoding with Compact Draft Models for Low-Latency Serving
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Deploy speculative decoding combining small draft models with large target models to accelerate generation speed by 2x without accuracy loss."*
