# ADR-0020: Consumer-Driven Contract Testing Adoption with Pact
...
Implement consumer-driven contract testing in CI pipelines to validate integration contracts without fragile end-to-end integration environments.
