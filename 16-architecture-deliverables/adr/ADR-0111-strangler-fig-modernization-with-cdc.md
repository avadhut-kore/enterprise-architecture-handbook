# ADR-0111: Strangler-Fig Monolith Modernization via Real-Time CDC
...
High-risk 'big-bang' rewrites historically failed, causing massive capital loss.

Mandate the Strangler Fig pattern with real-time Change Data Capture (CDC) for legacy modernizations.
...
## 4. Decision Outcome
**Deploy API gateway routing and Kafka Debezium CDC to incrementally extract domain services with zero downtime.**
