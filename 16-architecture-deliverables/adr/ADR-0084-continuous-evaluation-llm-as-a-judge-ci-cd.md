# ADR-0084: Automated Continuous Evaluation and LLM-as-a-Judge CI/CD Gating
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Mandate automated evaluation against golden test datasets in Git pull request pipelines, blocking merges that fail faithfulness or relevance thresholds."*
