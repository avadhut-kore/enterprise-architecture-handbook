# ADR-0081: Ephemeral Sandboxed MicroVM Execution for Dynamic Code Tools
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Require dynamic code execution tools to run inside isolated microVMs (AWS Firecracker / gVisor) with default-deny network egress."*
