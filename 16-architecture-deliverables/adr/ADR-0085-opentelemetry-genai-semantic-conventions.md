# ADR-0085: Standardizing on OpenTelemetry GenAI Semantic Conventions
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Instrument all generative AI components with OpenTelemetry semantic conventions, tracking TTFT, TPOT, and token cost telemetry."*
