# ADR-0029: Centralized API Gateway for Perimeter Ingress Governance
...
Enforce centralized edge API Gateways for external ingress security, rate limiting, and mTLS termination; avoid gateway business logic bloat.
