# ADR-0035: API-Led Integration over Point-to-Point Spaghetti
...
Prohibit unmanaged point-to-point system integrations; require API-led 3-tier layering or event-driven integration fabrics.
