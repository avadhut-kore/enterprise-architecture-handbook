# ADR-0039: Deterministic Rule-Based Matching over Fuzzy Matching in Reconciliation
...
Strictly enforce deterministic composite-key and amount matching; prohibit heuristic fuzzy matching on financial ledger entries.
