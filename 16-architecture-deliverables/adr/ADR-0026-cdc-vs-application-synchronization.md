# ADR-0026: Log-Based CDC over Application Dual-Writing for Data Sync
...
Prohibit application-level dual-writing; mandate log-based Change Data Capture (Debezium) for database-to-cache and search synchronization.
