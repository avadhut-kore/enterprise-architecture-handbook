# ADR-0096: Centralized vs Federated Enterprise Architecture
...
Large enterprise scale with 18 distinct business lines requires local agility combined with global compliance.

Adopt a Federated (Hub-and-Spoke) Enterprise Architecture operating model.
...
## 4. Decision Outcome
**Central EA defines core standards and paved roads; Domain Architects report to business units with dotted line to Chief Architect.**
