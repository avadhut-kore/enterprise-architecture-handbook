# ADR-0032: Mandatory Transactional Outbox Pattern for Domain Event Publishing
...
Require the Transactional Outbox pattern for all state-changing domain event publications to eliminate dual-write inconsistencies.
