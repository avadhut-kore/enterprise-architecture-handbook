# ADR-0010: Adoption of Modular Monolith Architecture Before Microservices
...
Default to a modular monolith for new domain initiatives to reduce operational overhead while preserving clean domain boundaries.
