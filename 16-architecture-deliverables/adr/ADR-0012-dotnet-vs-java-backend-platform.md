# ADR-0012: Backend Runtime Selection Criteria: .NET Core vs Java Virtual Machine
...
Standardize backend enterprise runtimes on .NET 8+ and Java 21+ based on workload profiles, team capability, and hosting environment.
