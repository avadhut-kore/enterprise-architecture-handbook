# ADR-0022: Relational SQL vs NoSQL Database Selection Policy
...
Default to relational SQL engines (PostgreSQL) for transactional core domains; require documented NFR justification for NoSQL adoption.
