# ADR-0094: Temporal Durable Execution for Multi-Step Long-Running AI Workflows
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Adopt Temporal as the enterprise standard for orchestrating stateful, multi-day agent workflows with automated event replay and retry policies."*
