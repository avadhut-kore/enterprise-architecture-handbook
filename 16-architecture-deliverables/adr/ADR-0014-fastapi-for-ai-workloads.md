# ADR-0014: FastAPI as Standard Gateway for AI and Machine Learning Microservices
...
Adopt Python FastAPI for high-throughput AI inference gateways and data science model serving.
