# ADR-0097: Global Core vs Regional Edge Platform Architecture
...
Strict data residency laws (GDPR, PIPL) and cross-border latency prohibit a single monolithic datacenter.

Adopt a Global Core / Regional Edge hybrid architecture for international systems.
...
## 4. Decision Outcome
**Global identity and financial rollups centralized; transactional vaults and payment gateways deployed in regional cloud hubs.**
