# ADR-0110: 20% Engineering Capacity Allocation for Architectural Debt
...
Chronic product delivery pressure accumulated 4,000 legacy CVEs and paralyzed release velocity.

Mandate that 20% of all engineering sprint capacity be dedicated to architectural debt reduction.
...
## 4. Decision Outcome
**Architectural debt cataloged with monetary interest costs; debt burn-down tracked in executive quarterly OKRs.**
