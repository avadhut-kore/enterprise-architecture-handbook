# ADR-0028: Stream-First vs Batch Data Pipeline Selection Criteria
...
Implement real-time streaming pipelines only when business SLAs require sub-minute freshness; default to ELT batch for analytical reporting.
