# ADR-0098: Application Portfolio Rationalization via the TIME Model
...
850 applications across the enterprise created redundant spend and high maintenance debt.

Mandate the Gartner TIME model for quarterly application portfolio evaluations.
...
## 4. Decision Outcome
**Applications classified into Tolerate, Invest, Migrate, Eliminate; Eliminate quadrant systems mandated for decommission.**
