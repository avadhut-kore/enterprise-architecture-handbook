# ADR-0015: Separation of Server State and Client State in Web Applications
...
Mandate TanStack Query / RTK Query for server state caching and lightweight state (Zustand / Signals) for ephemeral UI state.
