# ADR-0011: Standardizing on Clean Architecture for Core Domain Services
...
Enforce Clean / Hexagonal architecture principles across core enterprise services to isolate volatile external dependencies from business rules.
