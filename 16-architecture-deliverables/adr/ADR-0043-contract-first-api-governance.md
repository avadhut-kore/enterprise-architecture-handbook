# ADR-0043: Contract-First API Design & CI Verification
...
Require machine-readable OpenAPI and Protobuf contracts before writing code; enforce backward compatibility verification in CI pipelines.
