# ADR-0108: Enterprise Zero Trust Architecture & Identity Federation
...
Legacy perimeter VPN models left internal networks vulnerable to lateral ransomware movement.

Adopt Zero Trust architecture with centralized OIDC/OAuth2 and FIDO2 passwordless MFA.
...
## 4. Decision Outcome
**All internal and external network traffic untrusted by default; mutual TLS (mTLS) required between microservices.**
