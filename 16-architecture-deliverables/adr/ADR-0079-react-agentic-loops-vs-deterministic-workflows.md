# ADR-0079: Restricting Autonomous Agent Loops to Non-Deterministic Domains
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Mandate deterministic workflow engines (Temporal) for business processes; restrict autonomous ReAct loops strictly to exploratory, non-linear tasks."*
