# ADR-0087: Reversible PII Pseudonymization at the Gateway Layer
...
## Decision Outcome
**Chosen Option**: Adopted the architectural standard: *"Strip personal identifiable information (PII) before external cloud LLM calls, using temporary in-memory lookup tables to rehydrate client responses."*
