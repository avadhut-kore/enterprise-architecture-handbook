# Financial Case Study: Large-Volume Daily Batch Reconciliation (100M+ Rows)

## 1. Executive Summary & Problem Context
Designing a high-throughput matching engine using Spark and columnar memory joins, completing 100M row three-way matching within 45 minutes.
