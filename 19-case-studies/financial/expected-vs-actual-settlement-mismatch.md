# Financial Case Study: Production Incident: Expected vs Actual Settlement Mismatch

## 1. Executive Summary & Problem Context
Root cause analysis: processor applied an unannounced foreign currency conversion markup on international cross-border transactions, causing automated batch mismatch.
