# Enterprise Case Study: Global Authentication Outage Caused by Unannounced IdP Key Rotation

## 1. Business & System Context
Large-scale enterprise platform processing high-throughput mission-critical transactions.

## 2. Incident Description
Microservices crashed on unknown JWT `kid`. The failure resulted in customer disruption, elevated error budget burn rates, and executive escalation.
...
- **Target Architecture**: Automated JWKS dynamic caching with cache-miss bypass.
