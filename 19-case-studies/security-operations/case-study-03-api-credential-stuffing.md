# Enterprise Case Study: Distributed API Credential Stuffing & Account Takeover

## 1. Business & System Context
Large-scale enterprise platform processing high-throughput mission-critical transactions.

## 2. Incident Description
Bot traffic saturating auth endpoints. The failure resulted in customer disruption, elevated error budget burn rates, and executive escalation.
...
- **Target Architecture**: Edge WAF rate limiting and FIDO2 passkeys.
