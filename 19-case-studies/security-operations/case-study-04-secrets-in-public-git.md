# Enterprise Case Study: Production Database Credentials Committed to Public Git

## 1. Business & System Context
Large-scale enterprise platform processing high-throughput mission-critical transactions.

## 2. Incident Description
Hardcoded password leaked on GitHub. The failure resulted in customer disruption, elevated error budget burn rates, and executive escalation.
...
- **Target Architecture**: Gitleaks push protection and External Secrets Operator.
