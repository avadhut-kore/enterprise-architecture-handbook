# Enterprise Case Study: Production Outage Caused by Uncoordinated Secret Rotation

## 1. Business & System Context
Large-scale enterprise platform processing high-throughput mission-critical transactions.

## 2. Incident Description
Database password rotated while connection pool held old key. The failure resulted in customer disruption, elevated error budget burn rates, and executive escalation.
...
- **Target Architecture**: Dual-key overlap rotation pattern in HashiCorp Vault.
