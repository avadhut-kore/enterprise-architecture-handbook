# Enterprise Autonomous Procurement Agentic Workflow

## 1. Executive Summary
Orchestrating multi-vendor quote retrieval, invoice matching, and purchase order drafting via Temporal durable execution and ReAct agent loops.
