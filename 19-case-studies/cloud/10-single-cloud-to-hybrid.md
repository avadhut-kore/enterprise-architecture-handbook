# Case Study 10: Single-Cloud to Hybrid Cloud Architecture for Banking

## 1. Business Problem
An enterprise faced major architectural challenges in integrating cloud customer portals with core on-prem mainframe ledgers., requiring a comprehensive cloud infrastructure redesign.

---

## 2. Current Architecture
Legacy infrastructure with fragmented manual operations, scaling bottlenecks, and high operational maintenance overhead using AWS Direct Connect, BGP, Transit Gateway, Anti-Corruption Layer.
...
Selected **Option 3**. Modernized infrastructure utilizing AWS Direct Connect, BGP, Transit Gateway, Anti-Corruption Layer to achieve business velocity, operational resilience, and cost predictability.
