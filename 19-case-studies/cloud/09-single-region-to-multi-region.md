# Case Study 09: Evolving Single-Region to Multi-Region High Availability

## 1. Business Problem
An enterprise faced major architectural challenges in scaling global gaming infrastructure to withstand regional outages., requiring a comprehensive cloud infrastructure redesign.

---

## 2. Current Architecture
Legacy infrastructure with fragmented manual operations, scaling bottlenecks, and high operational maintenance overhead using AWS Route 53 ARC, Aurora Global Database, CloudFront.
...
Selected **Option 3**. Modernized infrastructure utilizing AWS Route 53 ARC, Aurora Global Database, CloudFront to achieve business velocity, operational resilience, and cost predictability.
