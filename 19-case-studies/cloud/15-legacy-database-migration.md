# Case Study 15: Migrating 14 TB On-Premises Oracle Database to Aurora PostgreSQL

## 1. Business Problem
An enterprise faced major architectural challenges in eliminating proprietary database licensing penalties with zero downtime., requiring a comprehensive cloud infrastructure redesign.

---

## 2. Current Architecture
Legacy infrastructure with fragmented manual operations, scaling bottlenecks, and high operational maintenance overhead using AWS SCT, AWS DMS with CDC, Reverse Replication.
...
Selected **Option 3**. Modernized infrastructure utilizing AWS SCT, AWS DMS with CDC, Reverse Replication to achieve business velocity, operational resilience, and cost predictability.
