...
flowchart TD
    ...
    subgraph CapabilityTier ["AI Capability Execution Tier"]
        AIGW --> BlueprintCore["AI CRM Integration Platform Reference Architecture Runtime"]
