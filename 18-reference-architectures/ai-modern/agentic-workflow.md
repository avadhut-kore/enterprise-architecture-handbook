...
flowchart TD
    ...
    subgraph CapabilityTier ["AI Capability Execution Tier"]
        AIGW --> BlueprintCore["Durable Agentic Workflow Reference Architecture Runtime"]
