# Reference Architecture: Payment Integration Platform Reference Architecture

## 1. Architectural Vision & Context
Payment orchestration gateway connecting multiple PSPs: smart routing, failover, tokenization vault isolation, and zero PCI scope leakage.
