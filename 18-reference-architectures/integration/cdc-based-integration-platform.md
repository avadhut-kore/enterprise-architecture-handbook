# Reference Architecture: CDC-Based Integration Platform Reference Architecture

## 1. Architectural Vision & Context
Log-based mutation streaming pipeline connecting operational databases directly to search engines, Redis caches, and downstream microservices.
