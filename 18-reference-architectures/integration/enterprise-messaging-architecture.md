# Reference Architecture: Enterprise Messaging Architecture (RabbitMQ/AMQP)

## 1. Architectural Vision & Context
Clustered message broker topology: direct, topic, and fanout exchanges, durable queues, consumer prefetch tuning, and dead-letter exchange handling.
