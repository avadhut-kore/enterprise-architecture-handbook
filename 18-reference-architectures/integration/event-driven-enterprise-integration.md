# Reference Architecture: Event-Driven Enterprise Integration Backbone

## 1. Architectural Vision & Context
Enterprise Kafka event bus with schema registry, outbox publisher agents, consumer worker pools, and automated dead-letter channel governance.
