# Reference Architecture: Python Django Clean Domain Architecture

## 1. Architectural Vision & Enterprise Context
Decoupling business logic from Django ORM fat models into explicit Domain Service and Selector layers to maximize testability and maintainability.
