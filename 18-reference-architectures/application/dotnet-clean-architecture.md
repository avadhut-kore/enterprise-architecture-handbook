# Reference Architecture: .NET Clean Architecture Enterprise Reference

## 1. Architectural Vision & Enterprise Context
Domain-centric architecture leveraging ASP.NET Core, MediatR, FluentValidation, EF Core, and strictly separated project dependencies without circular references.
