# Reference Architecture: Java Spring Boot Hexagonal (Ports & Adapters) Reference

## 1. Architectural Vision & Enterprise Context
Ports and adapters design isolating domain business logic from Spring annotations, using pure domain records/aggregates and pluggable infrastructure adapters.
