# Full-Stack Reference Architecture: React + Node.js NestJS End-to-End TypeScript Stack

## 1. Architectural Vision & End-to-End Context
Unified TypeScript monorepo (Turborepo/Nx) sharing domain types, DTO contracts, and validation schemas across React client and NestJS server.
