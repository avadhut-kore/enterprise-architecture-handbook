# Full-Stack Reference Architecture: Mobile React Native + Python FastAPI AI Platform

## 1. Architectural Vision & End-to-End Context
Edge mobile app performing local cache operations and offloading heavy machine learning inference to cloud-hosted FastAPI GPU workers.
