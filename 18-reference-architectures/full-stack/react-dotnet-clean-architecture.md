# Full-Stack Reference Architecture: React + .NET Clean Architecture Enterprise Stack

## 1. Architectural Vision & End-to-End Context
Modern Next.js frontend integrated with CQRS/Clean Architecture .NET Core backend via BFF (Backend-for-Frontend) edge layer.
