# Reference Architecture: Enterprise Data Warehouse Reference Architecture

## 1. Architectural Vision & Context
Massively parallel processing (MPP) cloud warehouse (Snowflake/BigQuery), star schema modeling, virtual compute warehouse sizing, and workload isolation.
