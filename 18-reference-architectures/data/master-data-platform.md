# Reference Architecture: Master Data Management (MDM) Platform Reference Architecture

## 1. Architectural Vision & Context
Multi-domain MDM hub (Customer 360, Product Master): deterministic/probabilistic matching, survivorship rules engine, and bidirectional operational syndication.
