# Reference Architecture: Data Lakehouse (Apache Iceberg) Reference Architecture

## 1. Architectural Vision & Context
Open table format lakehouse with ACID transactions, snapshot isolation, partition evolution, schema evolution, and automated compaction maintenance jobs.
