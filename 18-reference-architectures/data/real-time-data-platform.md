# Reference Architecture: Real-Time Streaming Data Platform Reference Architecture

## 1. Architectural Vision & Context
End-to-end streaming pipeline: Kafka ingestion, Apache Flink stateful processing with RocksDB, watermark management, and sub-second analytical sink materialization.
