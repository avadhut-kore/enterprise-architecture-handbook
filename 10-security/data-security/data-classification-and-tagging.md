# Data Security: Data Classification, Labeling & Automated Tagging

## 1. Architectural Purpose & Problem Context
Classifying enterprise data: Public, Internal, Confidential, Restricted (PII, PHI, Cardholder data); automated tagging via DLP scanners.
