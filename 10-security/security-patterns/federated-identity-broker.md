# Security Pattern: Federated Identity & B2B Broker Pattern
...
- **Threats Mitigated**: Partner credential management

## 4. Architectural Solution
```mermaid
flowchart LR
    A["Untrusted / Ingress"] --> B["Security Control: Federated Identity & B2B Broker Pattern"]
    B --> C["Protected Core Resource"]
```
Home Realm Discovery routing
