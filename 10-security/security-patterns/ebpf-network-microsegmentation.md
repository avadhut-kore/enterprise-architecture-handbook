# Security Pattern: Kernel-Level eBPF Microsegmentation Pattern
...
- **Threats Mitigated**: Flat container network lateral movement

## 4. Architectural Solution
```mermaid
flowchart LR
    A["Untrusted / Ingress"] --> B["Security Control: Kernel-Level eBPF Microsegmentation Pattern"]
    B --> C["Protected Core Resource"]
```
Cilium eBPF stateful firewall policies
