# Security Pattern: Service-to-Service Mutual TLS (mTLS) Pattern
...
- **Threats Mitigated**: East-west traffic sniffing

## 4. Architectural Solution
```mermaid
flowchart LR
    A["Untrusted / Ingress"] --> B["Security Control: Service-to-Service Mutual TLS (mTLS) Pattern"]
    B --> C["Protected Core Resource"]
```
SPIFFE X.509 mutual verification
