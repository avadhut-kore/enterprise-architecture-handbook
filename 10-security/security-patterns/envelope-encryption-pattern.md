# Security Pattern: Envelope Encryption Pattern
...
- **Threats Mitigated**: KMS rate limits on bulk data

## 4. Architectural Solution
```mermaid
flowchart LR
    A["Untrusted / Ingress"] --> B["Security Control: Envelope Encryption Pattern"]
    B --> C["Protected Core Resource"]
```
DEK/KEK hierarchical encryption
