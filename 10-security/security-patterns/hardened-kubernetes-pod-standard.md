# Security Pattern: Hardened Kubernetes Pod Standard Pattern
...
- **Threats Mitigated**: Container breakouts and host kernel compromise

## 4. Architectural Solution
```mermaid
flowchart LR
    A["Untrusted / Ingress"] --> B["Security Control: Hardened Kubernetes Pod Standard Pattern"]
    B --> C["Protected Core Resource"]
```
Distroless images with dropped capabilities
