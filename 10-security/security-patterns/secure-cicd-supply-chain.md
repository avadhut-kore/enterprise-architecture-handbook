# Security Pattern: Secure CI/CD & Software Supply Chain Pattern
...
- **Threats Mitigated**: Tampered builds and malicious packages

## 4. Architectural Solution
```mermaid
flowchart LR
    A["Untrusted / Ingress"] --> B["Security Control: Secure CI/CD & Software Supply Chain Pattern"]
    B --> C["Protected Core Resource"]
```
SLSA Level 3 hermetic builds and Cosign signing
