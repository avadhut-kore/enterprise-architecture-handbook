# Security Pattern: Secure Event Processing & Idempotency
...
- **Threats Mitigated**: Duplicate event fraud and replay

## 4. Architectural Solution
```mermaid
flowchart LR
    A["Untrusted / Ingress"] --> B["Security Control: Secure Event Processing & Idempotency"]
    B --> C["Protected Core Resource"]
```
Redis idempotency deduplication keys
