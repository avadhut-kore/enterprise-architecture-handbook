# Security Pattern: Centralized Identity Provider with OIDC
...
- **Threats Mitigated**: Fragmented credentials

## 4. Architectural Solution
```mermaid
flowchart LR
    A["Untrusted / Ingress"] --> B["Security Control: Centralized Identity Provider with OIDC"]
    B --> C["Protected Core Resource"]
```
Single Source of Truth SSO
