# Technology Comparison: Enterprise Integration Topologies Comparison

## 1. Architectural Evaluation Context
Point-to-Point vs Hub-and-Spoke vs API-Led vs Event-Driven vs iPaaS: coupling complexity, governance friction, and team agility.
