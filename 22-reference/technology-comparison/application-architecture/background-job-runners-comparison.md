# Technology Comparison: In-Application Background Job Runners Comparison

## 1. Architectural Evaluation Context
Hangfire vs Quartz.NET vs Celery vs BullMQ vs Spring @Scheduled: Persistence reliability, dashboard observability, distributed locking, and retry policies.
