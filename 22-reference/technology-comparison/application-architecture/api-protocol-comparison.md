# Technology Comparison: API Protocol & Transport Architecture Comparison

## 1. Architectural Evaluation Context
REST / OpenAPI vs gRPC / Protobuf vs GraphQL vs WebSockets: Payload efficiency, latency, schema governance, browser compatibility, and streaming support.
