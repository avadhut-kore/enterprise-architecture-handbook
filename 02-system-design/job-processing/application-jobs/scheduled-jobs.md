# Background Processing: Scheduled Jobs & Recurring Tasks

## 1. Architectural Purpose & Problem Context
Distributed schedulers vs in-process cron, avoiding multi-instance duplicate execution via DB locks.
