# CS-DEV-06: Containerizing a Legacy .NET Framework Monolith to Linux Containers

## 1. Executive Summary
Modernizing 12-year-old ASP.NET apps into .NET 8 chiseled containers running on AWS EKS.
