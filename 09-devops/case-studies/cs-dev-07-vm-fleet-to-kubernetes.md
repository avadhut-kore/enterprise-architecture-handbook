# CS-DEV-07: Decomposing a Sprawling VM Fleet to Production Kubernetes

## 1. Executive Summary
Migrating 800 pet virtual machines to declarative Kubernetes manifests with zero downtime.
