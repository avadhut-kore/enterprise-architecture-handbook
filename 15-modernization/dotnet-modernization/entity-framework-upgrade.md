...
## 1. Breaking Changes and Performance
EF Core is a complete rewrite of EF 6:
- Explicitly configure client-evaluation vs server-evaluation query rules.
- Replace legacy `.edmx` visual database diagrams with code-first EF Core Migrations.
