# Modernization: Monolithic Database Decomposition & Modernization

## 1. Architectural Purpose & Problem Context
Breaking shared enterprise databases: eliminating cross-domain database joins, establishing service data ownership, and CDC replication.
