# Legacy Decommissioning & Legal Data Archival

## 1. The Shutdown Checklist
- Ensure historical compliance data is exported to Parquet/PDF-A on immutable WORM storage.
- Retain legal search capabilities via serverless query engines (Amazon Athena) querying cold data.
- Power down hypervisors and cancel software vendor support contracts.
