# Reference Architecture: Mainframe Core to Cloud Event-Driven Caching Layer

## 1. Architectural Vision & Context
Offloading high-frequency read queries from an IBM z/OS mainframe to reduce MIPS licensing charges.
...
Mainframe DB2 Change Data Capture (Q-Replication), Kafka event backbone, Redis cluster servicing 98% of balance queries.
