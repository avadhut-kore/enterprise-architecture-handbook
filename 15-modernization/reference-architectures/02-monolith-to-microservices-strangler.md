# Reference Architecture: Monolith to Microservices via Strangler Fig

## 1. Architectural Vision & Context
Progressively extracting vertical slices from a monolithic system into autonomous microservices without downtime.
...
Envoy API Gateway facade, Anti-Corruption Layer, Kafka transactional outbox, database-per-service.
