# Case Study: National P&C Insurer: Guidewire Cloud Modernization

## 1. Executive Summary & Business Context
A property and casualty insurer migrated policy administration and claims processing from on-premise servers to cloud containers, reducing deployment lead time from 6 months to 2 weeks.
