# Decision Framework: Should We Replace with COTS / SaaS? Build vs. Buy

## 1. Problem Statement & Scope
Assess competitive differentiation: commodity processes (HR, CRM) go to SaaS; core IP stays custom.
