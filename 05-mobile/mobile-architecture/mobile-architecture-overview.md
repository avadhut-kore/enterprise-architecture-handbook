# Mobile Architecture: Enterprise Mobile Architecture Overview

## 1. Architectural Purpose & Problem Context
Execution constraints on iOS and Android: sandbox boundaries, memory limits, and lifecycle events.
