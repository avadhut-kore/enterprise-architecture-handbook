# Mobile Architecture: Local Storage Architecture: SQLite vs Key-Value

## 1. Architectural Purpose & Problem Context
Embedded relational engines (SQLite/Room/CoreData) vs fast key-value stores (MMKV/Nitro).
