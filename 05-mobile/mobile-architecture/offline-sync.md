# Mobile Architecture: Offline Synchronization & Conflict Resolution

## 1. Architectural Purpose & Problem Context
Two-way data sync, delta synchronization, timestamps, and Last-Write-Wins vs CRDT resolution.
