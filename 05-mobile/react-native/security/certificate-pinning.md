# React Native Architecture: SSL/TLS Certificate Pinning in React Native

## 1. Architectural Purpose & Problem Context
Mitigating Man-in-the-Middle (MITM) attacks by pinning public key hashes in native network clients.
