# React Native Architecture: Global Error Handling & JS/Native Crash Catching

## 1. Architectural Purpose & Problem Context
Catching unhandled JS exceptions and native crashes via Sentry for React Native.
