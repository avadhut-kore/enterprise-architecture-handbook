# Case Study: Global Cloud Transformation

---

## 1. Context
A multi-billion dollar Global 2000 enterprise facing acute digital disruption, escalating technology debt, and operational scaling bottlenecks. Migrating 1,200 enterprise workloads from 6 legacy colocation datacenters to an AWS multi-region landing zone while cutting run costs by $42M/yr.
