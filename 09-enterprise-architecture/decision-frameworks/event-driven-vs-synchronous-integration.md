# Decision Framework: Event-Driven vs Synchronous Integration

---

## 1. Context & Architectural Dilemma
> "Selecting between asynchronous event streaming (Kafka) and synchronous request-response (REST/gRPC)."
...
* Option A: Synchronous REST/gRPC (Simple, immediate response, cascading failure risk). Option B: Asynchronous Event-Driven (Resilient, highly decoupled, eventual consistency).
