# Decision Framework: AI Platform vs Application-Specific AI

---

## 1. Context & Architectural Dilemma
> "Deciding whether to build a shared enterprise AI gateway/platform or let individual squads call model APIs directly."
...
* Option A: Shared Enterprise AI Platform (Central rate limits, security, semantic caching). Option B: Ad-Hoc Direct API Calls (Fast local prototyping, rampant shadow IT, unmanaged cost).
