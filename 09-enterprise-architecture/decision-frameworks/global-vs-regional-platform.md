# Decision Framework: Global vs Regional Platform

---

## 1. Context & Architectural Dilemma
> "Deciding whether to deploy a single global platform or allow regional standalone platforms across jurisdictions."
...
* Option A: Single Global Platform (Low license cost, high compliance risk). Option B: Global Core + Regional Edge (Recommended). Option C: Disjoint Regional Systems (High duplicate TCO).
