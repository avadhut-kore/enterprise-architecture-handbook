# Anti-Pattern: Technology-Driven Strategy

---

## 1. The Symptom
> "Adopting emerging technologies (microservices, blockchain, generative AI) in search of a problem to solve."
...
1. **Enforce the Strategy-to-Execution hierarchy: Strategy -> Capability Need -> Technology Evaluation.**
