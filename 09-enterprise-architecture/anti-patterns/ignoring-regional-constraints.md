# Anti-Pattern: Ignoring Regional Constraints

---

## 1. The Symptom
> "Designing a single centralized global architecture that ignores local data sovereignty, latency, and currency regulations."
...
1. **Adopt the Global Core / Regional Edge model; partition data vaults by jurisdiction and terminate traffic at regional edge hubs.**
