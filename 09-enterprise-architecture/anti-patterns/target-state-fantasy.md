# Anti-Pattern: Target-State Fantasy

---

## 1. The Symptom
> "Designing target architectures that assume infinite budget, zero legacy constraints, and 100% greenfield conditions."
...
1. **Anchor target designs in current operational realities; account explicitly for data migration, legacy bridging, and dual-running costs.**
