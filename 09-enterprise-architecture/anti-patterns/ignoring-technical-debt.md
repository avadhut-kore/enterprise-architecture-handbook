# Anti-Pattern: Ignoring Technical Debt

---

## 1. The Symptom
> "Continuously delivering new features while hiding architectural debt, unpatched CVEs, and unsupported legacy versions."
...
1. **Enforce the 20% engineering capacity rule; track architectural debt on the formal enterprise risk register with monetary interest costs.**
