# Anti-Pattern: No Transition Architecture

---

## 1. The Symptom
> "Designing a gorgeous target-state architecture but providing zero intermediate transition plateaus to get there safely."
...
1. **Mandate that every target architecture includes at least two intermediate, standalone-valuable transition plateaus.**
