# Enterprise Reference Architecture: Insurance Enterprise Architecture

---

## 1. Business Context
An enterprise-grade reference blueprint designed for Global 2000 and Fortune 500 enterprises. P&C and Life insurance platform with automated FNOL claim triage, actuarial lakehouses, and policy administration.
...
```mermaid
graph TD
    Cap["Insurance Enterprise Architecture Core Capabilities"]
