# Architecture Practical Experience, Projects & Evidence Portfolios
...
## 1. Master Experience & Practice Playbooks
...
## 2. The 8-Stage Scope Ladder

```mermaid
flowchart LR
    S1["1. Feature"] --> S2["2. Subsystem"]
    S2 --> S3["3. Multi-Service"]
    S3 --> S4["4. Solution"]
    S4 --> S5["5. Platform"]
    S5 --> S6["6. Enterprise Integration"]
    S6 --> S7["7. Modernization"]
    S7 --> S8["8. Global Strategy"]
```
...
* **[Career Progression & Transition Playbooks](../career/README.md)** — Step-by-step role progression playbooks.
