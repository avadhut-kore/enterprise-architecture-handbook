# CS-105: Connected Vehicle Fleet Telemetry Pipeline

## 1. Executive Summary
Ingesting 5M connected vehicle telemetry streams via MQTT and Kafka into ClickHouse real-time analytics.
