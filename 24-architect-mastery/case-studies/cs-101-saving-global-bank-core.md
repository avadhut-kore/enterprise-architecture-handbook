# CS-101: Saving Global Bank Core: Mainframe to Event-Driven

## 1. Executive Summary
Migrating 20M accounts from 35-year-old COBOL mainframe to Kafka/PostgreSQL without single second of downtime.
