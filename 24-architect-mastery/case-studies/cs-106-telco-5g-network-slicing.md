# CS-106: Telco 5G Core Network Slicing Modernization

## 1. Executive Summary
Automating dynamic network slice provisioning on Kubernetes edge clusters with sub-5ms control planes.
