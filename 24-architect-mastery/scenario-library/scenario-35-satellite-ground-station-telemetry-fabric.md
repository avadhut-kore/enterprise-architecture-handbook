# SC-35: Low Earth Orbit (LEO) Satellite Telemetry Ground Network

## 1. Scenario Context & Business Driver
- **Domain**: Defense & Aerospace
- **Problem Statement**: Design and scale a mission-critical low earth orbit (leo) satellite telemetry ground network supporting planetary enterprise demands with high reliability and zero data loss.
...
- **Strategic Impact**: Modernizes low earth orbit (leo) satellite telemetry ground network into an autonomous, cost-optimized platform delivering 10x capacity with 40% reduced unit cost.
