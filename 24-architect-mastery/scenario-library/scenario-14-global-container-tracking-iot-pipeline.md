# SC-14: Global Intermodal Container Tracking & Sensor Pipeline

## 1. Scenario Context & Business Driver
- **Domain**: Logistics & Supply Chain
- **Problem Statement**: Design and scale a mission-critical global intermodal container tracking & sensor pipeline supporting planetary enterprise demands with high reliability and zero data loss.
...
- **Strategic Impact**: Modernizes global intermodal container tracking & sensor pipeline into an autonomous, cost-optimized platform delivering 10x capacity with 40% reduced unit cost.
