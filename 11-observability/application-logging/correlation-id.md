# Application Logging: Correlation ID Architecture

## 1. Architectural Purpose & Problem Context
Generating unique X-Correlation-ID headers at edge gateways and passing them down synchronous call chains.
