# Application Logging: Distributed Trace ID Injection (OpenTelemetry)

## 1. Architectural Purpose & Problem Context
Injecting W3C trace_id and span_id into every log record to bridge logs and distributed traces.
