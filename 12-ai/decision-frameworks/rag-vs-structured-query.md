# RAG vs. Structured SQL Query Decision Framework

## 1. Executive Summary & Context
Evaluating when to use vector retrieval vs. relational text-to-SQL for enterprise business reporting and aggregations.
...
```mermaid
flowchart TD
    Start["Evaluate Requirement: RAG vs. Structured SQL Query Decision Framework"] --> Check1{"Primary Constraint / SLA?"}
