...
Evaluates whether a problem should use AI or deterministic software based on value, determinism, data, accuracy, explainability, latency, cost, and risk. Explicitly supports: 'Do not use AI'.
...
```mermaid
flowchart TD
    Start["Evaluate Requirement: AI Suitability Decision Framework"] --> Check1{"Primary Constraint / SLA?"}
