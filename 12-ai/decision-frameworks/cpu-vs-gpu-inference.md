# CPU vs. GPU Inference Decision Framework

## 1. Executive Summary & Context
Determining when quantized Small Language Models can run economically on modern CPU instruction sets (AVX-512) vs. GPUs.
...
```mermaid
flowchart TD
    Start["Evaluate Requirement: CPU vs. GPU Inference Decision Framework"] --> Check1{"Primary Constraint / SLA?"}
