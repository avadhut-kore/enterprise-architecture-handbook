# LLM vs. Traditional ML Decision Framework

## 1. Executive Summary & Context
Choosing between statistical tree models (XGBoost/LightGBM) and Large Language Models for classification, scoring, and prediction.
...
```mermaid
flowchart TD
    Start["Evaluate Requirement: LLM vs. Traditional ML Decision Framework"] --> Check1{"Primary Constraint / SLA?"}
