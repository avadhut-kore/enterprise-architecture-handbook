# Small Model (SLM) vs. Large Model (LLM) Decision Framework

## 1. Executive Summary & Context
Evaluating 8B parameter models vs. 70B+ parameter models across accuracy, latency, and cost per million tokens.
...
```mermaid
flowchart TD
    Start["Evaluate Requirement: Small Model (SLM) vs. Large Model (LLM) Decision Framework"] --> Check1{"Primary Constraint / SLA?"}
