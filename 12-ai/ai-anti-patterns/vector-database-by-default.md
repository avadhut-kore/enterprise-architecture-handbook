# Vector Database by Default Anti-Pattern

## 1. Executive Summary & Core Flaw
Provisioning a dedicated vector database cluster before evaluating existing relational (pgvector) or search engines.
...
Vector Database by Default Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
