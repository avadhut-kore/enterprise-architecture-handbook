# Agent for Deterministic Workflows Anti-Pattern

## 1. Executive Summary & Core Flaw
Replacing predictable business state machines with autonomous agents that fail intermittently and burn tokens.
...
Agent for Deterministic Workflows Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
