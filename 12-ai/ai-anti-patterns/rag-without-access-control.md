# RAG Without Access Control Anti-Pattern

## 1. Executive Summary & Core Flaw
Indexing enterprise documents into a shared vector database without tenant metadata filtering, causing massive cross-tenant data leaks.
...
RAG Without Access Control Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
