# No Model Versioning Anti-Pattern

## 1. Executive Summary & Core Flaw
Calling unpinned model aliases (e.g., 'gpt-4o' instead of 'gpt-4o-2024-08-06'), causing silent breaking changes when providers update weights.
...
No Model Versioning Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
