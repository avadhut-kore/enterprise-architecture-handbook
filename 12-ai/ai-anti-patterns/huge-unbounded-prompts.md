# Huge Unbounded Prompts Anti-Pattern

## 1. Executive Summary & Core Flaw
Dumping hundreds of pages of uncompressed context into a prompt, triggering attention dilution ('lost in the middle') and 10x cost inflation.
...
Huge Unbounded Prompts Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
