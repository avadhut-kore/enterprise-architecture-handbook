# RAG When Structured Query is Sufficient Anti-Pattern

## 1. Executive Summary & Core Flaw
Attempting to vectorize relational database tables to answer aggregate financial questions ('total Q3 revenue') instead of executing SQL.
...
RAG When Structured Query is Sufficient Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
