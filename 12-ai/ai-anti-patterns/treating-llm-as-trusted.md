# Treating LLM as Trusted Entity Anti-Pattern

## 1. Executive Summary & Core Flaw
Positioning foundation models inside internal security boundaries and assuming their outputs are free from malicious injection.
...
Treating LLM as Trusted Entity Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
