# AI Gateway as a Bottleneck Anti-Pattern

## 1. Executive Summary & Core Flaw
Buffering full streaming token responses inside a centralized gateway, destroying user perceived latency (TTFT).
...
AI Gateway as a Bottleneck Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
