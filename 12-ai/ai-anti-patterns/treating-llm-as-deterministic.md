# Treating LLM as Deterministic Software Anti-Pattern

## 1. Executive Summary & Core Flaw
Assuming an identical prompt will always yield identical outputs, leading to brittle unit test suites and unhandled edge-case failures.
...
Treating LLM as Deterministic Software Anti-Pattern"] --> Step1["1. Establish Observability & Audit Baseline"]
