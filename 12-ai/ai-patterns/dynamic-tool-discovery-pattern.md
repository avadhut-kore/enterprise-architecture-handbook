...
## 1. Intent & Context
Enables AI agents to query a central Model Context Protocol (MCP) registry to discover, authenticate, and invoke enterprise tools dynamically at runtime. In enterprise distributed architectures, this pattern provides a proven, standardized blueprint for production reliability, cost control, and security isolation.
...
flowchart TD
    ...
    Gateway --> PatternCore["Dynamic Tool Discovery Pattern Core"]
