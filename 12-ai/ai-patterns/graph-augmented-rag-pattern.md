# Graph-Augmented RAG (GraphRAG) Pattern

## 1. Intent & Context
Combines knowledge graphs (Neo4j) with vector embeddings to enable global corpus summarization, entity relationship traversal, and multi-hop reasoning. In enterprise distributed architectures, this pattern provides a proven, standardized blueprint for production reliability, cost control, and security isolation.
...
flowchart TD
    ...
    Gateway --> PatternCore["Graph-Augmented RAG (GraphRAG) Pattern Core"]
