# Hybrid Search & Reranking Pattern

## 1. Intent & Context
Combines sparse lexical BM25 keyword search with dense HNSW vector retrieval, aggregating ranks via Reciprocal Rank Fusion and neural cross-encoder rerankers. In enterprise distributed architectures, this pattern provides a proven, standardized blueprint for production reliability, cost control, and security isolation.
...
flowchart TD
    ...
    Gateway --> PatternCore["Hybrid Search & Reranking Pattern Core"]
