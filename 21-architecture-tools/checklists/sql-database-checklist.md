# Architecture Checklist: Relational SQL Production Readiness Checklist

## Purpose & Scope
Indexes, connection pooling, execution plans, deadlock avoidance, PITR, and zero-downtime DDL.
