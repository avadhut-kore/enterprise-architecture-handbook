# Architecture Checklist: Data Lakehouse & Warehouse Production Checklist

## Purpose & Scope
Open table formats (Iceberg), bronze/silver/gold tiering, dbt model testing, and workload compute isolation.
