# Architecture Checklist: Enterprise Messaging & Queueing Checklist

## Purpose & Scope
Exchange topologies, queue durability, consumer prefetch, publisher confirms, and poison message handling.
