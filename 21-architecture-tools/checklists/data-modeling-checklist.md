# Architecture Checklist: Data Modeling & Schema Design Review Checklist

## Purpose & Scope
Relational normalization, partition key design, document embedding limits, and schema evolution rules.
