# Architecture Checklist: Data Streaming & Windowing Architecture Checklist

## Purpose & Scope
Event time watermarking, late event side-outputs, RocksDB state checkpoints, and backpressure.
