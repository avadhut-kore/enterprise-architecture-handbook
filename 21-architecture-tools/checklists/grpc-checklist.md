# Architecture Checklist: gRPC & Protocol Buffers Review Checklist

## Purpose & Scope
Protobuf field numbering rules, deadline propagation, L7 load balancing (Envoy), and streaming flow control.
