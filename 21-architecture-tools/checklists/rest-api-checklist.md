# Architecture Checklist: RESTful API Production Review Checklist

## Purpose & Scope
HTTP methods, status codes, pagination, rate limiting headers, RFC 7807 problem details, and ETags.
