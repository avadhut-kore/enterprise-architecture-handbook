# Architecture Checklist: Financial Data Mapping & Precision Checklist

## Purpose & Scope
Zero-loss integer cents / BigDecimal, ISO currency codes, banker's rounding, and correlation ID chains.
