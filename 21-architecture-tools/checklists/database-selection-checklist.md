# Architecture Checklist: Database Selection & Workload Assessment Checklist

## Purpose & Scope
ACID needs, read/write ratios, latency SLAs, query patterns, and operational complexity scorecards.
