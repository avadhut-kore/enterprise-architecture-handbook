# Architecture Checklist: NoSQL Database Production Architecture Checklist

## Purpose & Scope
Partition keys, hot partition mitigation, tunable consistency quorums, and tombstone compaction.
