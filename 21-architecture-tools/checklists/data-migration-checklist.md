# Architecture Checklist: Database Migration & Cutover Readiness Checklist

## Purpose & Scope
CDC replication catch-up, dual-write validation, checksum reconciliation, and instant rollback plans.
