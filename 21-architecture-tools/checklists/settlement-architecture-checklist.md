# Architecture Checklist: Enterprise Settlement Architecture Checklist

## Purpose & Scope
Gross vs net settlement, cut-off timestamps, batch checksum verification, and bank instruction formats.
