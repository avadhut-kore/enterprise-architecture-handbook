# Architecture Checklist: Event-Driven Architecture Review Checklist

## Purpose & Scope
Event naming, schema registry contracts, consumer idempotency, and dead-letter queue governance.
