# Architecture Checklist: Enterprise API Architecture & Strategy Checklist

## Purpose & Scope
API-first contracts, OpenAPI specs, semantic versioning, and deprecation sunset schedules.
