# Architecture Checklist: Third-Party SaaS Integration Review Checklist

## Purpose & Scope
OAuth token caching, rate limit backoff, vendor outage circuit breaking, and automated data backups.
