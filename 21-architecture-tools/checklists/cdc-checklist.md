# Architecture Checklist: Change Data Capture (CDC) Production Checklist

## Purpose & Scope
WAL retention sizing, primary key partition routing, schema evolution, and lag monitoring.
