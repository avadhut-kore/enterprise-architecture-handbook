# Architecture Checklist: Enterprise Integration Architecture Checklist

## Purpose & Scope
Point-to-point elimination, timeout policies, exponential retries with jitter, and bulkhead isolation.
