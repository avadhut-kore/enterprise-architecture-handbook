# Architecture Checklist: Apache Kafka Production Cluster & Topic Checklist

## Purpose & Scope
Partition counts, `acks=all`, `min.insync.replicas`, consumer rebalance assignors, and retention sizing.
