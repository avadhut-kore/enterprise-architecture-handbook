# Architecture Checklist: .NET Production Architecture Review

## Purpose & Scope
Async/await hygiene (no .Result), EF Core query optimization (no N+1), connection pooling, and memory allocation profiling.
