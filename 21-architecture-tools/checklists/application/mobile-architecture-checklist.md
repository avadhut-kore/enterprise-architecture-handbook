# Architecture Checklist: Mobile Application Architecture Review

## Purpose & Scope
Offline sync reliability, battery consumption, cold start latency, certificate pinning, and secure keychain/keystore storage.
