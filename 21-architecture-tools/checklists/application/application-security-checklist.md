# Architecture Checklist: Application Security Architecture Review

## Purpose & Scope
OWASP Top 10 defenses: SQL injection, XSS, CSRF, input validation, JWT signature verification, and secret rotation.
