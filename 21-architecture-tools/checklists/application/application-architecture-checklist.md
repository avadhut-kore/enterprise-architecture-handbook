# Architecture Checklist: Application Architecture General Review

## Purpose & Scope
General architectural health: modular boundaries, separation of concerns, testability, and non-functional requirement compliance.
