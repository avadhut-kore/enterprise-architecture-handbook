# Architecture Checklist: Application Integration & Resiliency Review

## Purpose & Scope
Timeout configurations, circuit breaker thresholds, idempotent consumer tokens, and outbox event publishing.
