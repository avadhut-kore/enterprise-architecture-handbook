# Architecture Checklist: Angular Enterprise Architecture Review

## Purpose & Scope
OnPush change detection, Signals adoption, standalone component migration, and lazy-loaded route chunking.
