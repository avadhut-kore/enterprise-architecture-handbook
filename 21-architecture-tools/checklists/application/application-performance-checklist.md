# Architecture Checklist: Application Performance & Capacity Review

## Purpose & Scope
Latency percentiles (P95/P99), database indexing, cache stampede mitigation, and garbage collection pauses.
