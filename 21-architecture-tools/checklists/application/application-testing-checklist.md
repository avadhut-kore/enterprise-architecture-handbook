# Architecture Checklist: Application Testing Strategy Review

## Purpose & Scope
Test pyramid adherence, unit test coverage on core domain logic, integration tests using testcontainers, and pact contract testing.
