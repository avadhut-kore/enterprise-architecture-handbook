# Architecture Checklist: Dependency Management & Composition Review

## Purpose & Scope
Inversion of control, service lifecycles (transient vs singleton), third-party library vulnerability scanning, and supply chain integrity.
