# Architecture Checklist: Code Organization & Layering Review

## Purpose & Scope
Packaging by feature vs layer, cyclical dependency avoidance, cohesion metrics, and public API surface minimization.
