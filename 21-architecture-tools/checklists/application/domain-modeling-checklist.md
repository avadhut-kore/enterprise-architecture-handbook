# Architecture Checklist: Domain Modeling & DDD Conformance Review

## Purpose & Scope
Anemic domain model prevention, rich entity business invariants, aggregate boundary consistency, and domain event isolation.
