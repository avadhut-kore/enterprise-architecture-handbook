# Architecture Checklist: Java Spring Boot Architecture Review

## Purpose & Scope
JVM heap tuning, virtual thread utilization, JPA open-session-in-view disabling, and component scan scoping.
