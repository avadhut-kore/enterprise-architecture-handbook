# Decision Framework: Retain vs Modernize

---

## 1. Context & Architectural Dilemma
> "Evaluating whether a legacy system should be preserved as-is or modernized."
...
* Option A: Retain / Tolerate (Low capital cost, high operational risk). Option B: Strangler-Fig Modernization (High capital, permanently lowers risk).
