# Decision Framework: Global vs Local Capability

---

## 1. Context & Architectural Dilemma
> "Allocating capability ownership between global headquarters and local country subsidiaries."
...
* Option A: Global Capability (Centrally deployed, uniform). Option B: Localized Capability (Tailored to regional regulations, local speed).
