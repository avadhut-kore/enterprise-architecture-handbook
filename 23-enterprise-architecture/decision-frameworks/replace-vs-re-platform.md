# Decision Framework: Replace vs Re-platform

---

## 1. Context & Architectural Dilemma
> "Choosing between replacing a legacy system with SaaS or re-platforming it onto cloud containers."
...
* Option A: Replace with SaaS (Standard processes, fast, high license cost). Option B: Re-platform to Cloud (Preserves custom logic, eliminates hardware debt).
