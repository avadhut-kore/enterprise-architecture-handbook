# Anti-Pattern: Endless Architecture Studies

---

## 1. The Symptom
> "Spending 12 months conducting comparative vendor analyses and POCs while competitors capture the market."
...
1. **Time-box architectural evaluations to 4 weeks; default to two-way door decisions that can be reversed if assumptions prove false.**
