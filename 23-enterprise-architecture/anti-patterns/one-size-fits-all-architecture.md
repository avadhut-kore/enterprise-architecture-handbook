# Anti-Pattern: One-Size-Fits-All Architecture

---

## 1. The Symptom
> "Applying identical architectural patterns (e.g., event-driven microservices on Kubernetes) to all systems regardless of scale."
...
1. **Fit architecture to problem complexity; use modular monoliths for simple systems and distributed architectures only for hyperscale.**
