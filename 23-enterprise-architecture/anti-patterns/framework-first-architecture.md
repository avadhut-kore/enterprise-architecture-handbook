# Anti-Pattern: Framework-First Architecture

---

## 1. The Symptom
> "Attempting to implement 100% of TOGAF, Zachman, or ArchiMate before making a single actual architectural decision."
...
1. **Treat frameworks as toolkits, not dogmas. Start with the problem: baseline inventory, gap analysis, and phased transition roadmap.**
