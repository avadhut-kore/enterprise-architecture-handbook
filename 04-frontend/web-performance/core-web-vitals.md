# Web Performance: Core Web Vitals: LCP, INP, and CLS

## 1. Architectural Purpose & Problem Context
Deep dive into Largest Contentful Paint (< 2.5s), Interaction to Next Paint (< 200ms), and Cumulative Layout Shift (< 0.1).
