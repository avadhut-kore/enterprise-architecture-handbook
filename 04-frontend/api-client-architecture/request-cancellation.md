# API Client Architecture: Request Cancellation via AbortController

## 1. Architectural Purpose & Problem Context
Canceling obsolete in-flight requests when users navigate away or type in search boxes.
