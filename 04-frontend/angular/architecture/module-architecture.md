# Angular Architecture: Legacy NgModules vs Modern Standalone Architecture

## 1. Architectural Purpose & Problem Context
Migrating from complex NgModule dependency hierarchies to lightweight standalone components.
