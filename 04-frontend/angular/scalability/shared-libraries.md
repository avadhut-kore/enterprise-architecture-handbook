# Angular Architecture: Building Enterprise Shared Angular Libraries

## 1. Architectural Purpose & Problem Context
Creating secondary entry points with ng-packagr for tree-shakable internal component libraries.
