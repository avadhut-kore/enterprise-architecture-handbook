# Angular Architecture: Enforcing Feature Boundaries with Nx Module Boundaries

## 1. Architectural Purpose & Problem Context
Linting rules to prevent circular references between UI libraries and domain features.
