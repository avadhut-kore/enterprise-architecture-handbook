# Angular Architecture: Architecting Large-Scale Angular Applications

## 1. Architectural Purpose & Problem Context
Managing enterprise monorepos using Nx: workspace layout, caching, and affected commands.
