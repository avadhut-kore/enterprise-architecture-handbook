# React Architecture: Integration Testing with MSW (Mock Service Worker)

## 1. Architectural Purpose & Problem Context
Mocking network requests at the network level without mocking fetch/axios client code.
