# React Architecture: Component Testing with React Testing Library

## 1. Architectural Purpose & Problem Context
Testing user behaviors and accessibility queries (getByRole) rather than implementation details.
