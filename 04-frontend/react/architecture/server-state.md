# React Architecture: Server State Architecture with TanStack Query

## 1. Architectural Purpose & Problem Context
Automatic background refetching, query invalidation, stale-while-revalidate, and deduplication.
