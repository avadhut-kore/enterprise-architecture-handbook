# React Architecture: Routing Architecture with Next.js App Router / TanStack Router

## 1. Architectural Purpose & Problem Context
File-system routing, nested layouts, parallel routes, and intercepting routes.
