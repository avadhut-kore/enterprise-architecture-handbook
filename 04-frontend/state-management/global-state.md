# Frontend State: Global Application State Architecture

## 1. Architectural Purpose & Problem Context
State shared across distant components (authenticated user identity, active theme, global notifications).
