# Frontend Architecture: Data Fetching & Cache Synchronization

## 1. Architectural Purpose & Problem Context
Server state caching, background refetching, cache deduplication, and optimistic mutations (TanStack Query / RTK Query).
