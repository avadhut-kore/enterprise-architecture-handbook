# Frontend Architecture: Routing Architecture & Code Splitting

## 1. Architectural Purpose & Problem Context
Route-based chunking, navigation guards, nested layouts, scroll restoration, and deep-link handling.
