# Frontend Architecture: Accessibility Architecture (WCAG 2.2 AA)

## 1. Architectural Purpose & Problem Context
Semantic HTML, keyboard navigation traps, screen reader landmarks, ARIA roles, and automated a11y testing.
