# Frontend Architecture: Frontend Performance Architecture

## 1. Architectural Purpose & Problem Context
Architectural levers for Core Web Vitals (LCP, INP, CLS), virtualization of large lists, and main thread budget enforcement.
