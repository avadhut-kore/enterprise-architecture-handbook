# Frontend Architecture: Frontend Testing Architecture

## 1. Architectural Purpose & Problem Context
Testing Trophy model: Unit tests for domain math, Component tests for interactive UI, and Playwright for E2E workflows.
