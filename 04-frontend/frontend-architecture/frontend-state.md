# Frontend Architecture: Frontend State Architecture Taxonomy

## 1. Architectural Purpose & Problem Context
Segregating Local UI State, Global Client State, Server Cache State, and URL State to eliminate synchronization bugs.
