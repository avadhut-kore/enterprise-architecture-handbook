# Frontend Architecture: Frontend Security Architecture

## 1. Architectural Purpose & Problem Context
XSS mitigation, secure cookie token storage (HttpOnly/SameSite), Content Security Policy (CSP), and avoiding DOM injection.
