# Data Migration: CDC-Assisted Database Migration Architecture

## 1. Architectural Purpose & Problem Context
Initial bulk baseline snapshot followed by continuous transaction log catch-up streaming until replication lag reaches zero.
