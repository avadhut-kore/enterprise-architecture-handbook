# Data Migration: Dual-Write & Shadow Traffic Migration Patterns

## 1. Architectural Purpose & Problem Context
Routing live production traffic: shadow read/write duplication, comparing results asynchronously, and validating parity before switching.
