# Data Mapping: Code Translation Tables & Enumeration Governance

## 1. Architectural Purpose & Problem Context
Managing disparate code vocabularies (e.g., ISO status codes vs internal legacy integer status codes) via governed, versioned lookup tables.
