# Data Mapping: File, Flat-File & Batch Mapping Architecture

## 1. Architectural Purpose & Problem Context
Processing fixed-width, CSV, and XML batch feeds: header/trailer controls, record delimiters, multi-record schemas, and streaming parsing.
