# Data Mapping: Field, Record & Entity Mapping Hierarchies

## 1. Architectural Purpose & Problem Context
Architectural scoping from primitive scalar conversions to composite aggregate structures and complex multi-entity graph transformations.
