# Data Mapping: Source-to-Target (S2T) Specification Architecture

## 1. Architectural Purpose & Problem Context
Designing formal, unambiguous S2T specifications covering data types, business rules, cardinality, nullability, and verification criteria.
