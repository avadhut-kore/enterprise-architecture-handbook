# Data Streaming: Tumbling, Hopping & Session Windows in Stream Processing

## 1. Architectural Purpose & Problem Context
Fixed-interval non-overlapping windows (tumbling), sliding overlapping windows (hopping), and dynamic inactivity-bounded session windows.
