# NoSQL Architecture: Wide-Column Database Architecture

## 1. Architectural Purpose & Problem Context
LSM-Tree storage mechanics (Memtable, CommitLog, SSTables, Compaction), masterless peer-to-peer gossip protocols, and query-driven schema design.
