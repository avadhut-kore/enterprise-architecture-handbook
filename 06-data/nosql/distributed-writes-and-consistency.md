# NoSQL Architecture: Distributed Writes & Tunable Consistency

## 1. Architectural Purpose & Problem Context
Quorum consistency formulas: `R + W > N`, sloppy quorums with hinted handoff, read repair, and active anti-entropy with Merkle trees.
