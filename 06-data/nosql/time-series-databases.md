# NoSQL Architecture: Time-Series Database Architecture

## 1. Architectural Purpose & Problem Context
Append-only temporal write streams, compression algorithms (Gorilla/Chimp), chunked partitioning, and automated lifecycle retention policies.
