# NoSQL Architecture: Graph Database Architecture

## 1. Architectural Purpose & Problem Context
Index-free adjacency, native graph storage vs graph compute layers, Cypher/Gremlin queries, and handling graph partition boundaries at scale.
