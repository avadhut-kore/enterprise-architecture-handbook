# NoSQL Architecture: Document Database Architecture

## 1. Architectural Purpose & Problem Context
JSON/BSON document stores, secondary indexing, write concern levels, replica sets, and balancing embedded sub-documents vs cross-document references.
