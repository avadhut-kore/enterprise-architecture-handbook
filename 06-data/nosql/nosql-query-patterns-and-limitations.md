# NoSQL Architecture: NoSQL Query Patterns & Design Limitations

## 1. Architectural Purpose & Problem Context
Overcoming lack of ad-hoc joins: application-level joins, denormalization, materializing query-specific views, and fan-out query hazards.
