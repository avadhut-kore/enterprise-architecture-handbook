# Data Platforms: Batch vs Streaming Data Platforms: Lambda vs Kappa

## 1. Architectural Purpose & Problem Context
Evaluating dual-path Lambda architecture vs unified stream-first Kappa architecture; maintenance complexity and consistency trade-offs.
