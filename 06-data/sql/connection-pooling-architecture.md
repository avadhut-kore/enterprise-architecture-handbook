# SQL Architecture: Connection Pooling Architecture & Sizing

## 1. Architectural Purpose & Problem Context
Sizing formula: `connections = ((core_count * 2) + effective_spindle_count)`, preventing thread starvation, and managing pool exhaustion under peak load.
