# SQL Architecture: Indexing Strategies & B-Tree Storage Internals

## 1. Architectural Purpose & Problem Context
Clustered vs non-clustered indexes, composite index column ordering, covering indexes, partial indexes, and B-Tree node split mechanics.
