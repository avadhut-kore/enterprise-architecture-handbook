# SQL Architecture: Deadlock Detection & Prevention Strategies

## 1. Architectural Purpose & Problem Context
Wait-for graphs, deadlock timeouts, lock ordering conventions, and architectural patterns to eliminate cyclic transaction dependencies.
