# SQL Architecture: Relational Database Engine Architecture

## 1. Architectural Purpose & Problem Context
Storage engine internals: Write-Ahead Logging (WAL), buffer pool management, dirty page flushing, table spaces, and row vs columnar page layouts.
