# SQL Architecture: ACID Semantics & Transaction Lifecycles

## 1. Architectural Purpose & Problem Context
Atomicity, Consistency, Isolation, and Durability mechanics: two-phase locking, undo/redo logs, commit protocols, and crash recovery.
