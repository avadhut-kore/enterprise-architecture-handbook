# SQL Architecture: High Availability & Automated Failover Topologies

## 1. Architectural Purpose & Problem Context
Active-passive with synchronous replication, multi-AZ deployment, split-brain mitigation via quorum witnesses, and client reconnect handling.
