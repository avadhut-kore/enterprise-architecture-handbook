# SQL Architecture: Backup, Restore & Point-in-Time Recovery (PITR)

## 1. Architectural Purpose & Problem Context
Continuous WAL archiving, differential/incremental backups, calculating RPO/RTO targets, and automated disaster recovery restore drills.
