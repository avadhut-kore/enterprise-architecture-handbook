# SQL Architecture: Concurrency Control & Locking Architecture

## 1. Architectural Purpose & Problem Context
Pessimistic vs Optimistic concurrency control, lock granularity (row, page, table), intention locks, and MVCC (Multi-Version Concurrency Control) internals.
