# SQL Architecture: Read Replicas & Replication Lag Mitigation

## 1. Architectural Purpose & Problem Context
Physical streaming replication vs logical replication, async replication lag windows, sticky sessions, and routing read-after-write traffic.
