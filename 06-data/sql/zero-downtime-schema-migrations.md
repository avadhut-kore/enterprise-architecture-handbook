# SQL Architecture: Zero-Downtime Schema Migrations (Expand/Contract)

## 1. Architectural Purpose & Problem Context
The Expand/Contract pattern: additive column changes, dual-writing, background backfills, view swaps, and online DDL locking avoidance.
