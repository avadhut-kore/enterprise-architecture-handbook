# SQL Architecture: Isolation Levels & Concurrency Anomalies

## 1. Architectural Purpose & Problem Context
From Read Uncommitted to Strict Serializable: dirty reads, non-repeatable reads, phantom reads, and write skew under Snapshot Isolation.
