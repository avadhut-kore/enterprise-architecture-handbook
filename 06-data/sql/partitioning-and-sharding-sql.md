# SQL Architecture: Partitioning & Sharding Strategies in SQL

## 1. Architectural Purpose & Problem Context
Declarative table partitioning (range, list, hash) vs application-level sharding, cross-shard query challenges, and global key distribution.
