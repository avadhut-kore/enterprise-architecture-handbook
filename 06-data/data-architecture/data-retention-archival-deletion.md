# Data Architecture: Data Retention, Tiered Archival & Cryptographic Deletion

## 1. Architectural Purpose & Problem Context
Automating lifecycle transitions from hot NVMe storage to cold cloud archives (S3 Glacier), immutability locks (WORM), and GDPR right-to-be-forgotten crypto-shredding.
