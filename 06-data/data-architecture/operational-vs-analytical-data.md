# Data Architecture: Operational Data vs Analytical Data Architecture

## 1. Architectural Purpose & Problem Context
Divergent architectural profiles: low-latency OLTP ACID access vs high-throughput OLAP batch aggregations and historical analysis.
