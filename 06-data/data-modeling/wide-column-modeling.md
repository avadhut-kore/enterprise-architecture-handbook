# Data Modeling: Wide-Column Data Modeling (Cassandra / ScyllaDB)

## 1. Architectural Purpose & Problem Context
Query-first modeling methodology: partitioning keys vs clustering keys, static columns, tombstones, and query-driven table denormalization.
