# Data Modeling: Event Modeling & Append-Only State Design

## 1. Architectural Purpose & Problem Context
Modeling state transitions as an immutable chronological sequence of business events; state reconstruction via event replay and snapshots.
