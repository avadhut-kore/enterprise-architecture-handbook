# Distributed Transactions: Workflow Orchestration Engines (Temporal, Cadence, AWS Step Functions)

## 1. Architectural Purpose & Problem Context
Durable execution engines: event history replay, virtual state machines, automatic retry backoffs, and long-running human-in-the-loop workflows.
