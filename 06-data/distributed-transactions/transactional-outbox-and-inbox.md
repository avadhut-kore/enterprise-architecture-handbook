# Distributed Transactions: Transactional Outbox & Inbox Patterns

## 1. Architectural Purpose & Problem Context
Guaranteeing atomic database updates and event publishing via outbox table with CDC polling, and consumer deduplication via idempotent inbox recording.
