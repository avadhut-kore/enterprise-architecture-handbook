# Distributed Transactions: Two-Phase Commit (2PC): Mechanics & Enterprise Pitfalls

## 1. Architectural Purpose & Problem Context
Prepare and Commit phases, coordinator single-point-of-failure, resource lock holding, and why 2PC is an anti-pattern in modern cloud-native architectures.
