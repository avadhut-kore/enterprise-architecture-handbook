# Data Synchronization: Event-Driven Data Synchronization Architecture

## 1. Architectural Purpose & Problem Context
Propagating state updates via domain events: temporal decoupling, selective field projection, and managing eventual consistency lag.
