# CDC Architecture: Trigger-Based CDC Architecture & Trade-offs

## 1. Architectural Purpose & Problem Context
Database trigger mechanics writing shadow audit tables; transactional simplicity vs write throughput degradation and maintenance overhead.
