# CDC Architecture: CDC to Analytical Data Lakehouse (Iceberg/Delta Lake)

## 1. Architectural Purpose & Problem Context
Streaming change logs into Apache Iceberg or Delta Lake tables: copy-on-write vs merge-on-read formats, compaction, and ACID upserts.
