# CDC Architecture: Database Transaction Log Mining Internals

## 1. Architectural Purpose & Problem Context
Parsing engine logs: PostgreSQL logical decoding (wal2json/pgoutput), MySQL binlog row-based replication, and Oracle GoldenGate / LogMiner.
