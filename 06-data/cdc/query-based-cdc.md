# CDC Architecture: Query-Based (Polling) CDC Architecture

## 1. Architectural Purpose & Problem Context
Timestamp and soft-delete polling patterns: database index requirements, missing intermediate state updates, and detecting hard deletions.
