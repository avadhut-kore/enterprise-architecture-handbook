# CDC Architecture: CDC Schema Evolution & Compatibility Governance

## 1. Architectural Purpose & Problem Context
Handling source DDL alterations (adding/dropping/renaming columns) without breaking downstream Kafka consumers and lakehouse ingestion.
