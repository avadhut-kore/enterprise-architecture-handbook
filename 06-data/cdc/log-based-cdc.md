# CDC Architecture: Log-Based Change Data Capture Architecture

## 1. Architectural Purpose & Problem Context
Zero-overhead mutation streaming by reading transaction write-ahead logs (WAL/binlog/oplog); eliminating dual-write risks and table polling overhead.
