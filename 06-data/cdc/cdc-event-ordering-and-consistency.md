# CDC Architecture: CDC Event Ordering & Consistency Guarantees

## 1. Architectural Purpose & Problem Context
Preserving transaction order across multiple tables, foreign key relationship hazards, and cross-partition ordering constraints.
