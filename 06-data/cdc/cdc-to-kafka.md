# CDC Architecture: CDC to Kafka Event Streaming Topologies

## 1. Architectural Purpose & Problem Context
Publishing database changes into Kafka topics: keying by primary key to preserve partition ordering, and flattening before/after envelopes.
