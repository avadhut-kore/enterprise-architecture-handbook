# CDC Architecture: CDC Pipelines with Debezium & Kafka Connect

## 1. Architectural Purpose & Problem Context
Debezium connector architecture: initial table snapshotting, continuous streaming, Kafka Connect distributed workers, and offset tracking.
