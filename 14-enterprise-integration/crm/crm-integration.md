# Principles of Enterprise CRM Integration

## 1. System of Engagement vs. System of Record
- **CRM (Salesforce / Dynamics)**: System of Engagement. Optimizes for sales velocity, marketing workflows, and customer communication.
- **ERP / Core Banking**: System of Record. Authoritative for accounting, legal contracts, inventory, and ledger balances.
- Never duplicate general ledger or raw invoice calculations inside CRM custom objects.
