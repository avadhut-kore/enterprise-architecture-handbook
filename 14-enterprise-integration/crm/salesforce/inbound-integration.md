# Inbound Integration & Connected Apps

## 1. Secure Inbound Access
External microservices integrate with Salesforce via Connected Apps using the OAuth 2.0 JWT Bearer Flow, exchanging an asymmetric private key signature for short-lived access tokens.
