...
## 1. High-Throughput ETL Pattern
Bulk API 2.0 simplifies ingesting datasets exceeding 100,000 records. Clients upload a single CSV file, and the Salesforce backend automatically partitions, parallelizes, and optimizes the batch execution.
