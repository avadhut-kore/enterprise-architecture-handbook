# Identity Federation and OAuth JWT Bearer Flow

## 1. Server-to-Server JWT Bearer Token Exchange
```
[External Integration Service] ──(Sign JWT with Private Key)──> [Salesforce OAuth]
                                                                        │
                                                                        ▼
[External Integration Service] ◄──(Returns Access Token)────────────────┘
```
