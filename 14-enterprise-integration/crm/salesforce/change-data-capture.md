# Salesforce Change Data Capture (CDC) Architecture

## 1. Real-Time Data Replication
CDC publishes streaming mutation events (`CREATE`, `UPDATE`, `DELETE`) for standard and custom sObjects, carrying the modified fields and a persistent `replayId` for replay recovery.
