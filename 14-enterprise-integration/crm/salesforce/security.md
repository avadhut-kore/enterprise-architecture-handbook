# Salesforce Integration Security: Shield & Network Controls

## 1. Security Architecture
- **Shield Platform Encryption**: Encrypts sensitive fields at rest within the database.
- **Login IP Ranges**: Restrict API client access strictly to designated corporate static egress IP addresses.
- **Least Privilege**: Service accounts must be assigned dedicated integration profiles with field-level security restrictions.
