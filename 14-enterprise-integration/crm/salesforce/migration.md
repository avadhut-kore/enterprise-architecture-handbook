# Salesforce Data Migration and External ID Indexing

## 1. Preventing Duplicates with External IDs
Designate foreign system keys (e.g., `ERP_Customer_ID__c`) as **External ID & Unique** fields, enabling idempotent `upsert` operations and preventing duplicate record creation.
