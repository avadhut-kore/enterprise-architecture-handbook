# Salesforce Governor Limits and Capacity Planning

## 1. Critical Limits Management
- Monitor daily API consumption via the `Limits` REST resource.
- Consolidate chatty point-to-point updates into Composite API subrequests (up to 25 operations per call).
- Route bulk migrations exclusively through Bulk API 2.0.
