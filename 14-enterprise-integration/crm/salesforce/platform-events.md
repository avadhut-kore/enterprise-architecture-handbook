# Salesforce Platform Events and the Pub/Sub API

## 1. Event Bus Architecture
Platform Events run on an internal Kafka bus. External enterprise consumers subscribe via the modern **Pub/Sub API (gRPC)** to receive real-time business events with automatic commit offset tracking and replay capabilities.
