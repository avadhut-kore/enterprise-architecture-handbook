# Customer 360 Integration Architecture

## 1. Data Virtualization Pattern
Rather than synchronizing millions of transactional ERP invoices into the CRM database (which incurs steep storage license costs), deploy **Salesforce External Objects (OData v4)** to virtualize external financial data directly within the CRM user interface on-demand.
