# Payment Idempotency and Anti-Duplicate Architecture

## 1. The Threat of Duplicate Charges
Accidental network retries, mobile browser refreshes, or consumer double-clicks can result in duplicate card charges, causing severe customer dissatisfaction, chargebacks, and compliance fines.

## 2. Anti-Duplicate Token Engine
See [integration-reliability/idempotency.md](../integration-reliability/idempotency.md) for full implementation details.
