# Secrets Management and Credential Rotation in CDE

## 1. Secret Hygiene Controls
- Zero credentials committed to git or embedded in containers.
- Dynamic credential provisioning via HashiCorp Vault with TTL $\le 1$ hour.
- Automated API key rotation every 90 days or immediately upon suspected compromise.
