# Payment Tokenization and Detokenization Vaults

## 1. Irreversible Vault Architecture
The tokenization vault maps sensitive PANs to pseudo-random tokens. The database storing this mapping is housed within the most strictly isolated enclave of the CDE, accessible exclusively via authenticated gRPC calls with mutual TLS.
