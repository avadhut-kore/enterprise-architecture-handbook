# Third-Party Service Provider Governance (Requirement 12.8)

## 1. Vendor Compliance Management
For every third-party service provider handling CHD or impacting CDE security:
- Maintain an active Attestation of Compliance (AOC).
- Establish a written agreement acknowledging the provider's responsibility for cardholder data security.
