...
* Machine-to-machine (M2M) authentication must rely on cryptographically verifiable identities (SPIFFE IDs, X.509 certs, or OAuth client IDs), never hardcoded shared passwords.
