# Observability Across Distributed Cloud and Mainframe

## 1. Bridging OpenTelemetry and SMF Logs
Inject correlation IDs into CICS commareas and IBM MQ headers, correlating cloud distributed traces with mainframe System Management Facility (SMF) record logs.
