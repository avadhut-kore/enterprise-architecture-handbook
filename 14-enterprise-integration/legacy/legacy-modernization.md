# Legacy Modernization Framework: The 7 Rs

## 1. Evaluation Matrix
- **Rehost (Lift & Shift)**: Move mainframe to cloud emulator (AWS Mainframe Modernization).
- **Replatform**: Move DB2 to PostgreSQL; keep COBOL runtime.
- **Refactor**: Convert COBOL to Java/C# using automated migration tools.
- **Replace**: Decommission legacy software in favor of modern SaaS.
