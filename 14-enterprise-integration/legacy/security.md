# Legacy Security: RACF, ACF2, and Identity Federation

## 1. Security Protocol Translation
Mainframes enforce authorization via RACF (Resource Access Control Facility):
- Modern API Gateways validate caller JWT tokens and map them to authorized RACF mainframe user IDs via an enterprise identity broker.
