# Legacy API Wrapping and Modern Microservice Facades

## 1. The Facade Pattern
Expose modern OpenAPI-compliant REST / gRPC interfaces to cloud channels while encapsulating legacy socket and CICS protocols inside a dedicated facade microservice.
