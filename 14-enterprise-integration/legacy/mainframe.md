# IBM z/OS Mainframe Architecture and CICS Integration

## 1. Mainframe Transaction Managers
- **CICS (Customer Information Control System)**: High-throughput online transaction processing (OLTP) monitor. Integrates via CICS Transaction Gateway (CTG) or IBM z/OS Connect Enterprise Edition.
- **IMS (Information Management System)**: Hierarchical database and transaction monitor.
