# Bi-Directional Legacy Synchronization and Conflict Resolution

## 1. Conflict Resolution Rules
When updates occur concurrently in both legacy and modern platforms:
- **Rule of Authority**: Specific fields are owned strictly by one system.
- **Last-Write-Wins with Timestamp**: Resolves non-critical data conflicts.
- **Quarantine on Divergence**: Financial mismatches trigger human review tickets.
