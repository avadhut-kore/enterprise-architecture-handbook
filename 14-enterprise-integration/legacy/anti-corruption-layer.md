...
## 1. Preserving Domain Purity
Never allow 40-year-old mainframe variable names (`CUST-STAT-CD-01`) to leak into modern domain models:
- **ACL Translator**: Translates legacy codes into clean domain enums (`CustomerStatus.ACTIVE`).
