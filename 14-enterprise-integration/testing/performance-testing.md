# High-Throughput Load and Soak Testing

## 1. Test Profiles with k6 / Gatling
- **Stress Test**: Ramp traffic to identify breaking threshold.
- **Soak Test**: Run at 80% capacity for 24 hours to detect memory leaks and connection pool starvation.
