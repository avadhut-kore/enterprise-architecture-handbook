# Component Integration Testing with Testcontainers

## 1. Ephemeral Real Dependencies
Avoid mocking databases and message brokers. Use **Testcontainers** to spin up real instances of PostgreSQL, Kafka, and Redis inside Docker during unit and integration test runs.
