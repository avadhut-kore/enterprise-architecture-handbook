# Security Testing: DAST, Fuzzing, and Token Tampering

## 1. API Security Testing
Run automated OWASP ZAP and Postman security suites to test JWT signature tampering, missing OAuth scopes, and rate limit evasion.
