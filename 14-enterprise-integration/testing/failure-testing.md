# Chaos Engineering and Network Failure Injection

## 1. Toxiproxy Failure Scenarios
Inject network latency, packet drops, and bandwidth limits to verify that circuit breakers trip and retries backoff correctly under hostile conditions.
