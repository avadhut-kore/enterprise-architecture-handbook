# Reconciliation Engine and Break Matching Testing

## 1. Injecting Synthetic Breaks
Verify reconciliation engines by deliberately injecting unmatched records, rounding variances, and duplicate ledger entries into test batches.
