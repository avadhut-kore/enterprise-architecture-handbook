# Wrapping Legacy Systems with Modern REST APIs

## 1. Facade Pattern
Expose standard OpenAPI 3.0 contracts to external channels while encapsulating proprietary legacy socket, terminal, and CICS protocols inside a dedicated adapter layer.
