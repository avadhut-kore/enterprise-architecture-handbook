# Cutover Weekend Execution Protocols

## 1. Critical Path Runbook
Step-by-step timed execution checklist from initial transaction freeze to final DNS propagation.
