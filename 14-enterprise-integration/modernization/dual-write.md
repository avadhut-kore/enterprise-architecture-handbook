# Why Synchronous Dual-Writes Fail

## 1. The Distributed Inconsistency Trap
Writing to both legacy and modern databases in application code guarantees divergence when the second write fails or network times out. Always use the **Transactional Outbox Pattern** with CDC.
