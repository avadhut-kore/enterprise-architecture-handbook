...
## 1. Phased Migration
- **Phase 1**: Bulk historical snapshot load.
- **Phase 2**: Real-time CDC replication catching up in-flight mutations.
- **Phase 3**: Dual-read verification verifying identical query responses.
- **Phase 4**: Switch write master.
