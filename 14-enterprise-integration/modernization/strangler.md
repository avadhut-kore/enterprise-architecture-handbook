...
## 1. Migration Steps
1. Deploy API Gateway in front of legacy application.
2. Route 100% of traffic to legacy.
3. Build new cloud service for a specific domain entity (e.g., Customer Profile).
4. Shift 5% of traffic to new service (Canary).
5. Ramp traffic to 100%; decommission legacy customer module.
