# Multi-Year Coexistence and Dual-Run Strategy

## 1. Maintaining Single Source of Truth
Never allow split-brain writes. For each entity type, designate either the legacy system or the modern system as the authoritative writer, replicating mutations asynchronously to the other.
