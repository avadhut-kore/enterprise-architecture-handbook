# Case Study: Tier-1 Global Bank: Mainframe Core Modernization

## 1. Executive Summary
A multinational retail bank with 40 million accounts replaced a 35-year-old IBM z14 mainframe core banking engine with a cloud-native event-driven architecture using Kafka, Redis, and Debezium, reducing mainframe MIPS bills by $45M annually.
