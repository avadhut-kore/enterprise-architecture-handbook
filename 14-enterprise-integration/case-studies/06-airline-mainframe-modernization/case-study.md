# Case Study: Major International Airline: Passenger Service Strangler

## 1. Executive Summary
An airline migrated flight booking, seat inventory, and frequent flyer operations off a legacy TPF mainframe using the Strangler Fig pattern, processing 15,000 searches/sec during peak holiday travel.
