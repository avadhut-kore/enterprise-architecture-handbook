# Healthcare Audit Logging: ATNA and IHE Profiles

## 1. IHE ATNA (Audit Trail and Node Authentication)
The ATNA integration profile mandates:
- Mutual TLS authentication between all communicating clinical actor nodes.
- Centralized syslog audit repository collecting standardized XML-encoded audit records (RFC 3881 / DICOM PS 3.19).
- Strict non-repudiation of patient record reads, updates, and disclosures.
