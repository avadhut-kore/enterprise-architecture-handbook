...
- **1-to-1 Match**: Exact match on Transaction ID and Amount.
- **1-to-Many Match**: A single bulk deposit matches 50 individual customer invoices.
- **Fuzzy Match**: Match on customer name and approximate date within a $\pm \$0.05$ fee tolerance window.
