# Batch Reconciliation Pipelines

## 1. End-of-Day File Ingestion
Batch reconciliation runs during overnight non-peak hours, processing millions of bank statement lines (CAMT.053, MT940) against internal billing records.
