# Real-Time Stream Reconciliation (Apache Flink)

## 1. Tumbling and Sliding Window Joins
Use Apache Flink stateful stream processing to join payment authorization events with settlement events over a rolling 10-minute window, alerting immediately if authorization legs are missing settlement acknowledgments.
