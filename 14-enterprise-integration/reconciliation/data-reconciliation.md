# Distributed Database Data Reconciliation

## 1. Row-Level Checksum Comparison
To verify that a read-replica database is perfectly synchronized with the source database without copying gigabytes of raw data:
1. Compute Merkle tree hashes of database partitions.
2. Compare root hashes across databases.
3. Drill down into mismatched branches to identify specific out-of-sync rows.
