# Automated Discrepancy Retry and Re-submission

## 1. Auto-Repairing Dropped Legs
When a reconciliation engine identifies a payment that was captured but never posted to the CRM, it automatically fires an asynchronous event to replay the missing write.
