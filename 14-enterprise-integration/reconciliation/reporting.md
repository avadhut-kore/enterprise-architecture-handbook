# Executive Break Reporting and Risk Dashboards

## 1. KPI Metrics
- Net unreconciled exposure value ($).
- Percentage of breaks resolved automatically ($\ge 99.5\%$).
- Volume of breaks aging past regulatory deadlines (> 72 hours).
