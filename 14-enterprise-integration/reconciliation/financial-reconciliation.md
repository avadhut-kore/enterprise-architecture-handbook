# Financial Reconciliation and Double-Entry Balancing

## 1. Balance Sheet Balancing
Every financial movement involves two legs. Financial reconciliation verifies:
$$\sum 	ext{Debits} == \sum 	ext{Credits}$$
Any variance represents an unreconciled break that must be investigated before books are closed.
