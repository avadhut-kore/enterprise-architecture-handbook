# Automated vs. Manual Ledger Adjustments

## 1. Threshold-Based Auto-Adjustment
Enterprise governance rules allow automated posting of write-offs for rounding discrepancies under a set threshold (e.g., $< \$1.00$). Any break exceeding this limit requires dual-signoff manual approval.
