# SAP Technical Landscape: NetWeaver & In-Memory HANA

## 1. Multi-Tier Architecture
- **AS ABAP**: Application server runtime executing business logic and work processes (Dialog, Update, Batch).
- **HANA Database**: In-memory columnar database enabling real-time operational analytics and instantaneous aggregations.
