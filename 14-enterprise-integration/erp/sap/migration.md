# ECC to S/4HANA Integration Migration Roadmap

## 1. Migration Pathways
- **Greenfield**: Redesigning all integrations around standard public OData APIs, the SAP Business Accelerator Hub, and Event Mesh.
- **Brownfield**: Lifting existing interfaces and introducing temporary Anti-Corruption Layers (ACL) to translate legacy RFC/BAPI calls to S/4HANA structures.
