# SAP SD (Sales & Distribution) Integration Architecture

## 1. Order-to-Cash Endpoints
Sales orders originating from e-commerce, CRM, or EDI are ingested into SAP SD:
- Validates customer credit limits against SAP Credit Management.
- Executes real-time Available-to-Promise (ATP) checks against plant inventory.
- Creates outbound delivery documents for warehouse execution.
