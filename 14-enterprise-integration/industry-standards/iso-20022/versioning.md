# ISO 20022 Versioning and Annual Maintenance Cycles

## 1. Annual Standards Release (SR)
ISO 20022 schemas evolve through annual maintenance cycles published by the ISO Standards Evaluation Group (SEG):
- Financial institutions have a 12-month window to deploy updated schemas.
- Integration architectures must support **Multi-Version Dual Ingestion** during migration cutover weekends.
