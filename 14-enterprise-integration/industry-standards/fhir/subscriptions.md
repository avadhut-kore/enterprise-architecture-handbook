# FHIR Subscriptions Framework (Event-Driven FHIR)

## 1. REST-Hook Architecture
FHIR Subscriptions enable push-based notifications:
1. Client registers Subscription resource specifying topic/criteria and target webhook URL.
2. FHIR server matches real-time mutations against criteria.
3. Server emits notification ping to target webhook, prompting client to pull delta changes.
