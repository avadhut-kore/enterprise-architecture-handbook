# Patient Identity and Resource Cross-Referencing

## 1. The Identifier System Model
FHIR uses a URI-based `system` and `value` pair to model identifiers from disparate external registries:
```json
{
