# FHIR Consent and Granular Data Access Control

## 1. Consent Policy Enforcement Point (PEP)
A healthcare API gateway must intercept clinical read queries and evaluate them against active patient `Consent` resources (e.g., withholding psychiatric or substance abuse notes from general insurance inquiries).
