# Semantic Interoperability and Conformance Checking

## 1. CapabilityStatement
Every compliant FHIR server exposes its metadata via `GET [base]/metadata`, returning a `CapabilityStatement` listing supported resources, search parameters, and security extensions.
