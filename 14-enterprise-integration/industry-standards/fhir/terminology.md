# FHIR Terminology Services: CodeSystem, ValueSet, ConceptMap

## 1. Terminology Operations
- `$lookup`: Query details of a code in a CodeSystem.
- `$validate-code`: Validate whether a code is a member of a ValueSet.
- `$translate`: Translate a code from one system to another using a ConceptMap.
