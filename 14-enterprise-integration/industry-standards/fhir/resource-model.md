# The FHIR Resource Data Model and Extension Semantics

## 1. The 80/20 Rule
FHIR's core architecture follows the **80/20 rule**: only data elements present in 80% of healthcare systems globally are incorporated into the core standard. The remaining 20% must be supported via **Extensions**.
