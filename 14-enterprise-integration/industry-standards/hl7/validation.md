# HL7 v2 Conformance Testing and Schema Validation

## 1. Conformance Profiles
Integration architects define message conformance profiles specifying required fields, allowed repetitions, and table bindings, automatically rejecting non-conformant messages with an `MSA|AR` reject packet.
