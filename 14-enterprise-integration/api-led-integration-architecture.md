# Enterprise Integration: API-Led Integration Architecture: 3-Tier Layering

## 1. Architectural Purpose & Problem Context
The 3-tier API hierarchy: System APIs (core systems), Process APIs (business logic orchestration), and Experience APIs (client-specific presentation).
