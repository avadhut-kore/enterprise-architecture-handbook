# Dual-Speed Batch Window Bridge Pattern

## 1. Bridging 24x7 Real-Time with Overnight Batch
Buffers daytime real-time customer mutations in an in-flight cache, batching them into flat files during the legacy system's overnight ingestion window.
