...
## 1. Restoring Chronological Stream Order
When network routing delivers messages out of order, the Resequencer buffers messages in a sorted heap and emits them downstream only in sequential order based on an incrementing sequence number.
