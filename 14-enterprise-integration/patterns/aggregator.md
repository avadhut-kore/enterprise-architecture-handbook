...
## 1. Stateful Message Recombination
The inverse of the Splitter: collects individual related messages sharing a correlation ID, buffers them in Redis until completion conditions are met (e.g., count reaches $N$ or timeout expires), and publishes a single combined batch message.
