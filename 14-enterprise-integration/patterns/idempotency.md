...
## 1. Deduplicating Inbound Messages
Stores message fingerprints or transaction IDs in a deduplication cache, ignoring duplicate deliveries. Detailed in [integration-reliability/idempotency.md](../integration-reliability/idempotency.md).
