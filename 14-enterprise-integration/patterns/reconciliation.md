# Asynchronous Reconciliation Loop Pattern

## 1. Detecting and Repairing Eventual Consistency Drift
An out-of-band audit worker that compares independent ledgers and databases, automatically triggering compensating transactions or alerts for human review.
