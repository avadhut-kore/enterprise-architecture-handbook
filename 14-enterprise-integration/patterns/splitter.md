...
## 1. Decomposing Composite Messages
Breaks a single composite message containing multiple line items (e.g., an invoice with 500 items) into 500 individual messages processed in parallel across worker nodes.
