...
## 1. Routing by Payload Inspection
Inspects the actual business fields within the message body (e.g., routing orders with `country == 'US'` to the US fulfillment queue and `country == 'DE'` to the EU fulfillment queue).
