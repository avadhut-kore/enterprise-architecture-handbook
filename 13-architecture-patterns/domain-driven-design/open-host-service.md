# Domain-Driven Design: Open Host Service (OHS): Public Service APIs

## 1. Problem & Context
A subsystem provides a standardized public protocol or API (REST/gRPC) for any consumer to integrate with without custom negotiated contracts.
