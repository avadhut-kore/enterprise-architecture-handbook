# Domain-Driven Design: Value Objects: Immutable Conceptual Wholes

## 1. Problem & Context
Objects defined solely by their attributes with no identity. Immutable, self-validating, and compared via structural equality (Money, Address, DateRange).
