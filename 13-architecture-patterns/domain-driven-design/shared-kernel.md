# Domain-Driven Design: Shared Kernel: Co-Owned Shared Libraries

## 1. Problem & Context
A tightly controlled subset of domain models shared between two contexts. High coordination overhead; use with extreme caution.
