# Domain-Driven Design: Subdomain Classification & Portfolio Strategy

## 1. Problem & Context
Decomposing the business problem space into Core, Supporting, and Generic subdomains to allocate engineering resources effectively.
