# Domain-Driven Design: Conformist: Direct Alignment with Upstream

## 1. Problem & Context
The downstream team accepts and conforms directly to the upstream team's domain model without an Anti-Corruption Layer.
