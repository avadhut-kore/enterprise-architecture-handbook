# Domain-Driven Design: Published Language: Standard Exchange Contracts

## 1. Problem & Context
A standardized translation format (JSON Schema, XML Schema, Protobuf) used by bounded contexts to communicate without direct coupling.
