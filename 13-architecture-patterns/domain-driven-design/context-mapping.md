# Domain-Driven Design: Context Mapping: Relationship Topologies

## 1. Problem & Context
Mapping structural, organizational, and technical relationships between different bounded contexts across the enterprise.
