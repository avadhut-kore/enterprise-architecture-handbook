# Domain-Driven Design: Bounded Contexts: Explicit Semantic Perimeters

## 1. Problem & Context
Defining boundaries within which a domain model and ubiquitous language strictly apply. Shows why a 'User' in Auth has a different meaning than a 'Customer' in Billing.
