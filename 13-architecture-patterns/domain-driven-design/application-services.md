# Domain-Driven Design: Application Services: Use-Case Orchestrators

## 1. Problem & Context
Thin coordinators that load aggregates from repositories, invoke domain methods, manage transactions, and emit integration events without containing business rules.
