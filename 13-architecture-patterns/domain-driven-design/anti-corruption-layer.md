# Domain-Driven Design: Anti-Corruption Layer (ACL): Translating Foreign Models

## 1. Problem & Context
A translation layer that isolates clean internal domain models from legacy, vendor, or third-party cryptic schemas.
