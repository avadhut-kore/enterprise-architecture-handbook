# Domain-Driven Design: Ubiquitous Language: Shared Vocabulary

## 1. Problem & Context
Establishing a rigorous, unambiguous vocabulary shared between domain experts, business analysts, architects, and developers, reflected directly in code.
