# Domain-Driven Design: Repositories: Collection-Oriented Persistence

## 1. Problem & Context
Interfaces that emulate in-memory collections of aggregate roots, mediating between the domain layer and database infrastructure.
