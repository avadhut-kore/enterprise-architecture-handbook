# Domain-Driven Design: Domain-Driven Design Overview & Value Framework

## 1. Problem & Context
Explains when DDD provides transformative value (complex core domains with high business logic churn) and when it is an antipattern (simple CRUD, reporting, or data-pipeline apps).
