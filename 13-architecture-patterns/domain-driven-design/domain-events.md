# Domain-Driven Design: Domain Events: In-Memory Domain Notifications

## 1. Problem & Context
Capturing something meaningful that occurred in the domain (OrderPlacedEvent) within the same transactional context.
