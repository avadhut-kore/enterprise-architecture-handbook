# Domain-Driven Design: Domain Model vs Technical Data Model

## 1. Problem & Context
Contrasts the relational database table schema (technical persistence) with the rich behavioral domain model (business policies, state transitions, and invariants).
