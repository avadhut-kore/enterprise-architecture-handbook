# Domain-Driven Design: Integration Events: Cross-Context Communication

## 1. Problem & Context
Asynchronous events published over Kafka/RabbitMQ to notify external bounded contexts, using serialized DTO contracts.
