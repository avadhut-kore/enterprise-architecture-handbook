# Domain-Driven Design: Domain Services: Pure Business Operations

## 1. Problem & Context
Stateless operations that naturally belong to the domain but involve multiple aggregates or do not fit cleanly inside a single entity.
