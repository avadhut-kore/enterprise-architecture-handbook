# Domain-Driven Design: Customer-Supplier: Upstream/Downstream Dynamics

## 1. Problem & Context
An upstream team (supplier) must deliver requirements requested by the downstream team (customer) to satisfy business timelines.
