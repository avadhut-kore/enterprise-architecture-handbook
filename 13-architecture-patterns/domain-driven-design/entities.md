# Domain-Driven Design: Entities: Identity Over Attributes

## 1. Problem & Context
Domain objects defined by a unique, continuous identity throughout their lifecycle, rather than their ephemeral attributes.
