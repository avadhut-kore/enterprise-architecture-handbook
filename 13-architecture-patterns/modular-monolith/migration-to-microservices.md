# Modular Monolith: Step-by-Step Microservice Extraction

## 1. Problem & Architectural Context
How a properly encapsulated module can be sliced out and migrated to an independent microservice within days without touching business logic.
