# Modular Monolith: Scaling the Modular Monolith

## 1. Problem & Architectural Context
Horizontal scaling strategies: scaling the unified container horizontally behind an L7 load balancer, and offloading heavy asynchronous tasks to background workers.
