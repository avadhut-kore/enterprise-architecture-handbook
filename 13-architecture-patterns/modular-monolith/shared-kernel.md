# Modular Monolith: The Shared Kernel in a Modular Monolith

## 1. Problem & Architectural Context
Restricting the shared kernel to immutable value objects (Money, Currency) and base domain primitives; banning domain entity sharing.
