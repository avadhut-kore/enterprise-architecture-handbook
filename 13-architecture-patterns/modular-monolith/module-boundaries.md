# Modular Monolith: Module Boundary Definition & Encapsulation

## 1. Problem & Architectural Context
Structuring modules as separate C# projects or Java modules with internal classes and a dedicated `.Contracts` project exposing only interfaces, DTOs, and events.
