# Modular Monolith: In-Process Event-Driven Architecture

## 1. Problem & Architectural Context
Publishing internal domain events over in-memory event dispatchers to trigger side effects in neighboring modules without tight coupling.
