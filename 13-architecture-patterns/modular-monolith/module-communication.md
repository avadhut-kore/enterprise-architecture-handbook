# Modular Monolith: Inter-Module Communication Topologies

## 1. Problem & Architectural Context
Comparing synchronous direct interface calls via facades against asynchronous decoupled in-memory domain events.
