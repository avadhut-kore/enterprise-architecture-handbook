# Modular Monolith: Automated Governance & Boundary Enforcement

## 1. Problem & Architectural Context
Implementing automated architecture tests in CI (NetArchTest/ArchUnit) that fail the build if one module tries to query another module's internal classes or database tables.
