# Modular Monolith: Transaction Boundaries Across Modules

## 1. Problem & Architectural Context
Deciding when to use a single database transaction across modules vs applying the Transactional Outbox pattern internally to prepare for future extraction.
